...
public class BarrierOption extends OneAssetOption {
  ...
  public double impliedVolatility(double targetValue, GeneralizedBlackScholesProcess process, DividendSchedule dividends, double accuracy, long maxEvaluations, double minVol, double maxVol) {
    return QuantLibJNI.BarrierOption_impliedVolatility__SWIG_5(swigCPtr, this, targetValue, GeneralizedBlackScholesProcess.getCPtr(process), process, DividendSchedule.getCPtr(dividends), dividends, accuracy, maxEvaluations, minVol, maxVol);
  }
  ...
  public double impliedVolatility(double targetValue, GeneralizedBlackScholesProcess process, DividendSchedule dividends, double accuracy, long maxEvaluations, double minVol) {
    return QuantLibJNI.BarrierOption_impliedVolatility__SWIG_6(swigCPtr, this, targetValue, GeneralizedBlackScholesProcess.getCPtr(process), process, DividendSchedule.getCPtr(dividends), dividends, accuracy, maxEvaluations, minVol);
  }
  ...
  public double impliedVolatility(double targetValue, GeneralizedBlackScholesProcess process, DividendSchedule dividends, double accuracy, long maxEvaluations) {
    return QuantLibJNI.BarrierOption_impliedVolatility__SWIG_7(swigCPtr, this, targetValue, GeneralizedBlackScholesProcess.getCPtr(process), process, DividendSchedule.getCPtr(dividends), dividends, accuracy, maxEvaluations);
  }
  ...
  public double impliedVolatility(double targetValue, GeneralizedBlackScholesProcess process, DividendSchedule dividends, double accuracy) {
    return QuantLibJNI.BarrierOption_impliedVolatility__SWIG_8(swigCPtr, this, targetValue, GeneralizedBlackScholesProcess.getCPtr(process), process, DividendSchedule.getCPtr(dividends), dividends, accuracy);
  }

  public double impliedVolatility(double targetValue, GeneralizedBlackScholesProcess process, DividendSchedule dividends) {
    return QuantLibJNI.BarrierOption_impliedVolatility__SWIG_9(swigCPtr, this, targetValue, GeneralizedBlackScholesProcess.getCPtr(process), process, DividendSchedule.getCPtr(dividends), dividends);
  }
