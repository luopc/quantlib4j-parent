...
public class LocalVolTermStructureHandle {
  ...
  public LocalVolTermStructureHandle() {
    this(QuantLibJNI.new_LocalVolTermStructureHandle__SWIG_0(), true);
  }

  public LocalVolTermStructureHandle(LocalVolTermStructure p, boolean registerAsObserver) {
    this(QuantLibJNI.new_LocalVolTermStructureHandle__SWIG_1(LocalVolTermStructure.getCPtr(p), p, registerAsObserver), true);
  }

  public LocalVolTermStructureHandle(LocalVolTermStructure p) {
    this(QuantLibJNI.new_LocalVolTermStructureHandle__SWIG_2(LocalVolTermStructure.getCPtr(p), p), true);
  }
  ...
  public void enableExtrapolation(boolean b) {
    QuantLibJNI.LocalVolTermStructureHandle_enableExtrapolation__SWIG_0(swigCPtr, this, b);
  }

  public void enableExtrapolation() {
    QuantLibJNI.LocalVolTermStructureHandle_enableExtrapolation__SWIG_1(swigCPtr, this);
  }

  public void disableExtrapolation(boolean b) {
    QuantLibJNI.LocalVolTermStructureHandle_disableExtrapolation__SWIG_0(swigCPtr, this, b);
  }

  public void disableExtrapolation() {
    QuantLibJNI.LocalVolTermStructureHandle_disableExtrapolation__SWIG_1(swigCPtr, this);
  }
