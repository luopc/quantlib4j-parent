...
public class PiecewiseNaturalCubicZero extends YieldTermStructure {
  ...
  public DoubleVector data() {
    return new DoubleVector(QuantLibJNI.PiecewiseNaturalCubicZero_data(swigCPtr, this), false);
  }
