...
public class DeltaVolQuoteHandle {
  ...
  public DeltaVolQuoteHandle() {
    this(QuantLibJNI.new_DeltaVolQuoteHandle__SWIG_0(), true);
  }

  public DeltaVolQuoteHandle(DeltaVolQuote p, boolean registerAsObserver) {
    this(QuantLibJNI.new_DeltaVolQuoteHandle__SWIG_1(DeltaVolQuote.getCPtr(p), p, registerAsObserver), true);
  }

  public DeltaVolQuoteHandle(DeltaVolQuote p) {
    this(QuantLibJNI.new_DeltaVolQuoteHandle__SWIG_2(DeltaVolQuote.getCPtr(p), p), true);
  }
