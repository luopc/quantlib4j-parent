...
public class FraRateHelper extends RateHelper {
  ...
  public static FraRateHelper forDates(QuoteHandle rate, Date startDate, Date endDate, IborIndex index, Pillar.Choice pillar, Date customPillarDate, boolean useIndexedCoupon) {
    long cPtr = QuantLibJNI.FraRateHelper_forDates__SWIG_0(QuoteHandle.getCPtr(rate), rate, Date.getCPtr(startDate), startDate, Date.getCPtr(endDate), endDate, IborIndex.getCPtr(index), index, pillar.swigValue(), Date.getCPtr(customPillarDate), customPillarDate, useIndexedCoupon);
  ...
  public static FraRateHelper forDates(QuoteHandle rate, Date startDate, Date endDate, IborIndex index, Pillar.Choice pillar, Date customPillarDate) {
    long cPtr = QuantLibJNI.FraRateHelper_forDates__SWIG_1(QuoteHandle.getCPtr(rate), rate, Date.getCPtr(startDate), startDate, Date.getCPtr(endDate), endDate, IborIndex.getCPtr(index), index, pillar.swigValue(), Date.getCPtr(customPillarDate), customPillarDate);
    return (cPtr == 0) ? null : new FraRateHelper(cPtr, true);
  }

  public static FraRateHelper forDates(QuoteHandle rate, Date startDate, Date endDate, IborIndex index, Pillar.Choice pillar) {
    long cPtr = QuantLibJNI.FraRateHelper_forDates__SWIG_2(QuoteHandle.getCPtr(rate), rate, Date.getCPtr(startDate), startDate, Date.getCPtr(endDate), endDate, IborIndex.getCPtr(index), index, pillar.swigValue());
    return (cPtr == 0) ? null : new FraRateHelper(cPtr, true);
  }

  public static FraRateHelper forDates(QuoteHandle rate, Date startDate, Date endDate, IborIndex index) {
    long cPtr = QuantLibJNI.FraRateHelper_forDates__SWIG_3(QuoteHandle.getCPtr(rate), rate, Date.getCPtr(startDate), startDate, Date.getCPtr(endDate), endDate, IborIndex.getCPtr(index), index);
    return (cPtr == 0) ? null : new FraRateHelper(cPtr, true);
  }
