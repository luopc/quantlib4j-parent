...
public class FdBlackScholesVanillaEngine extends PricingEngine {
  ...
  public FdBlackScholesVanillaEngine(GeneralizedBlackScholesProcess process, DividendSchedule dividends, long tGrid, long xGrid, long dampingSteps, FdmSchemeDesc schemeDesc, boolean localVol, double illegalLocalVolOverwrite, FdBlackScholesVanillaEngine.CashDividendModel cashDividendModel) {
    this(QuantLibJNI.new_FdBlackScholesVanillaEngine__SWIG_16(GeneralizedBlackScholesProcess.getCPtr(process), process, DividendSchedule.getCPtr(dividends), dividends, tGrid, xGrid, dampingSteps, FdmSchemeDesc.getCPtr(schemeDesc), schemeDesc, localVol, illegalLocalVolOverwrite, cashDividendModel.swigValue()), true);
  }
  ...
  public FdBlackScholesVanillaEngine(GeneralizedBlackScholesProcess process, DividendSchedule dividends, long tGrid, long xGrid, long dampingSteps, FdmSchemeDesc schemeDesc, boolean localVol, double illegalLocalVolOverwrite) {
    this(QuantLibJNI.new_FdBlackScholesVanillaEngine__SWIG_17(GeneralizedBlackScholesProcess.getCPtr(process), process, DividendSchedule.getCPtr(dividends), dividends, tGrid, xGrid, dampingSteps, FdmSchemeDesc.getCPtr(schemeDesc), schemeDesc, localVol, illegalLocalVolOverwrite), true);
  }
  ...
  public FdBlackScholesVanillaEngine(GeneralizedBlackScholesProcess process, DividendSchedule dividends, long tGrid, long xGrid, long dampingSteps, FdmSchemeDesc schemeDesc, boolean localVol) {
    this(QuantLibJNI.new_FdBlackScholesVanillaEngine__SWIG_18(GeneralizedBlackScholesProcess.getCPtr(process), process, DividendSchedule.getCPtr(dividends), dividends, tGrid, xGrid, dampingSteps, FdmSchemeDesc.getCPtr(schemeDesc), schemeDesc, localVol), true);
  }
  ...
  public FdBlackScholesVanillaEngine(GeneralizedBlackScholesProcess process, DividendSchedule dividends, long tGrid, long xGrid, long dampingSteps, FdmSchemeDesc schemeDesc) {
    this(QuantLibJNI.new_FdBlackScholesVanillaEngine__SWIG_19(GeneralizedBlackScholesProcess.getCPtr(process), process, DividendSchedule.getCPtr(dividends), dividends, tGrid, xGrid, dampingSteps, FdmSchemeDesc.getCPtr(schemeDesc), schemeDesc), true);
  }
  ...
  public FdBlackScholesVanillaEngine(GeneralizedBlackScholesProcess process, DividendSchedule dividends, long tGrid, long xGrid, long dampingSteps) {
    this(QuantLibJNI.new_FdBlackScholesVanillaEngine__SWIG_20(GeneralizedBlackScholesProcess.getCPtr(process), process, DividendSchedule.getCPtr(dividends), dividends, tGrid, xGrid, dampingSteps), true);
  }
  ...
  public FdBlackScholesVanillaEngine(GeneralizedBlackScholesProcess process, DividendSchedule dividends, long tGrid, long xGrid) {
    this(QuantLibJNI.new_FdBlackScholesVanillaEngine__SWIG_21(GeneralizedBlackScholesProcess.getCPtr(process), process, DividendSchedule.getCPtr(dividends), dividends, tGrid, xGrid), true);
  }

  public FdBlackScholesVanillaEngine(GeneralizedBlackScholesProcess process, DividendSchedule dividends, long tGrid) {
    this(QuantLibJNI.new_FdBlackScholesVanillaEngine__SWIG_22(GeneralizedBlackScholesProcess.getCPtr(process), process, DividendSchedule.getCPtr(dividends), dividends, tGrid), true);
  }

  public FdBlackScholesVanillaEngine(GeneralizedBlackScholesProcess process, DividendSchedule dividends) {
    this(QuantLibJNI.new_FdBlackScholesVanillaEngine__SWIG_23(GeneralizedBlackScholesProcess.getCPtr(process), process, DividendSchedule.getCPtr(dividends), dividends), true);
  }
  ...
  public FdBlackScholesVanillaEngine(GeneralizedBlackScholesProcess arg0, DividendSchedule dividends, FdmQuantoHelper quantoHelper, long tGrid, long xGrid, long dampingSteps, FdmSchemeDesc schemeDesc, boolean localVol, double illegalLocalVolOverwrite, FdBlackScholesVanillaEngine.CashDividendModel cashDividendModel) {
    this(QuantLibJNI.new_FdBlackScholesVanillaEngine__SWIG_24(GeneralizedBlackScholesProcess.getCPtr(arg0), arg0, DividendSchedule.getCPtr(dividends), dividends, FdmQuantoHelper.getCPtr(quantoHelper), quantoHelper, tGrid, xGrid, dampingSteps, FdmSchemeDesc.getCPtr(schemeDesc), schemeDesc, localVol, illegalLocalVolOverwrite, cashDividendModel.swigValue()), true);
  }
  ...
  public FdBlackScholesVanillaEngine(GeneralizedBlackScholesProcess arg0, DividendSchedule dividends, FdmQuantoHelper quantoHelper, long tGrid, long xGrid, long dampingSteps, FdmSchemeDesc schemeDesc, boolean localVol, double illegalLocalVolOverwrite) {
    this(QuantLibJNI.new_FdBlackScholesVanillaEngine__SWIG_25(GeneralizedBlackScholesProcess.getCPtr(arg0), arg0, DividendSchedule.getCPtr(dividends), dividends, FdmQuantoHelper.getCPtr(quantoHelper), quantoHelper, tGrid, xGrid, dampingSteps, FdmSchemeDesc.getCPtr(schemeDesc), schemeDesc, localVol, illegalLocalVolOverwrite), true);
  }
  ...
  public FdBlackScholesVanillaEngine(GeneralizedBlackScholesProcess arg0, DividendSchedule dividends, FdmQuantoHelper quantoHelper, long tGrid, long xGrid, long dampingSteps, FdmSchemeDesc schemeDesc, boolean localVol) {
    this(QuantLibJNI.new_FdBlackScholesVanillaEngine__SWIG_26(GeneralizedBlackScholesProcess.getCPtr(arg0), arg0, DividendSchedule.getCPtr(dividends), dividends, FdmQuantoHelper.getCPtr(quantoHelper), quantoHelper, tGrid, xGrid, dampingSteps, FdmSchemeDesc.getCPtr(schemeDesc), schemeDesc, localVol), true);
  }
  ...
  public FdBlackScholesVanillaEngine(GeneralizedBlackScholesProcess arg0, DividendSchedule dividends, FdmQuantoHelper quantoHelper, long tGrid, long xGrid, long dampingSteps, FdmSchemeDesc schemeDesc) {
    this(QuantLibJNI.new_FdBlackScholesVanillaEngine__SWIG_27(GeneralizedBlackScholesProcess.getCPtr(arg0), arg0, DividendSchedule.getCPtr(dividends), dividends, FdmQuantoHelper.getCPtr(quantoHelper), quantoHelper, tGrid, xGrid, dampingSteps, FdmSchemeDesc.getCPtr(schemeDesc), schemeDesc), true);
  }
  ...
  public FdBlackScholesVanillaEngine(GeneralizedBlackScholesProcess arg0, DividendSchedule dividends, FdmQuantoHelper quantoHelper, long tGrid, long xGrid, long dampingSteps) {
    this(QuantLibJNI.new_FdBlackScholesVanillaEngine__SWIG_28(GeneralizedBlackScholesProcess.getCPtr(arg0), arg0, DividendSchedule.getCPtr(dividends), dividends, FdmQuantoHelper.getCPtr(quantoHelper), quantoHelper, tGrid, xGrid, dampingSteps), true);
  }
  ...
  public FdBlackScholesVanillaEngine(GeneralizedBlackScholesProcess arg0, DividendSchedule dividends, FdmQuantoHelper quantoHelper, long tGrid, long xGrid) {
    this(QuantLibJNI.new_FdBlackScholesVanillaEngine__SWIG_29(GeneralizedBlackScholesProcess.getCPtr(arg0), arg0, DividendSchedule.getCPtr(dividends), dividends, FdmQuantoHelper.getCPtr(quantoHelper), quantoHelper, tGrid, xGrid), true);
  }
  ...
  public FdBlackScholesVanillaEngine(GeneralizedBlackScholesProcess arg0, DividendSchedule dividends, FdmQuantoHelper quantoHelper, long tGrid) {
    this(QuantLibJNI.new_FdBlackScholesVanillaEngine__SWIG_30(GeneralizedBlackScholesProcess.getCPtr(arg0), arg0, DividendSchedule.getCPtr(dividends), dividends, FdmQuantoHelper.getCPtr(quantoHelper), quantoHelper, tGrid), true);
  }
  ...
  public FdBlackScholesVanillaEngine(GeneralizedBlackScholesProcess arg0, DividendSchedule dividends, FdmQuantoHelper quantoHelper) {
    this(QuantLibJNI.new_FdBlackScholesVanillaEngine__SWIG_31(GeneralizedBlackScholesProcess.getCPtr(arg0), arg0, DividendSchedule.getCPtr(dividends), dividends, FdmQuantoHelper.getCPtr(quantoHelper), quantoHelper), true);
  }
