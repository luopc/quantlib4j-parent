...
public class DepositRateHelper extends RateHelper {
  ...
  public DepositRateHelper(QuoteHandle rate, Date fixingDate, IborIndex index) {
    this(QuantLibJNI.new_DepositRateHelper__SWIG_4(QuoteHandle.getCPtr(rate), rate, Date.getCPtr(fixingDate), fixingDate, IborIndex.getCPtr(index), index), true);
  }
