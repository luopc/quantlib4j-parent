...
public class CapFloorTermVolatilityStructureHandle {
  ...
  public CapFloorTermVolatilityStructureHandle() {
    this(QuantLibJNI.new_CapFloorTermVolatilityStructureHandle__SWIG_0(), true);
  }

  public CapFloorTermVolatilityStructureHandle(CapFloorTermVolatilityStructure p, boolean registerAsObserver) {
    this(QuantLibJNI.new_CapFloorTermVolatilityStructureHandle__SWIG_1(CapFloorTermVolatilityStructure.getCPtr(p), p, registerAsObserver), true);
  }

  public CapFloorTermVolatilityStructureHandle(CapFloorTermVolatilityStructure p) {
    this(QuantLibJNI.new_CapFloorTermVolatilityStructureHandle__SWIG_2(CapFloorTermVolatilityStructure.getCPtr(p), p), true);
  }
  ...
  public void enableExtrapolation(boolean b) {
    QuantLibJNI.CapFloorTermVolatilityStructureHandle_enableExtrapolation__SWIG_0(swigCPtr, this, b);
  }

  public void enableExtrapolation() {
    QuantLibJNI.CapFloorTermVolatilityStructureHandle_enableExtrapolation__SWIG_1(swigCPtr, this);
  }

  public void disableExtrapolation(boolean b) {
    QuantLibJNI.CapFloorTermVolatilityStructureHandle_disableExtrapolation__SWIG_0(swigCPtr, this, b);
  }

  public void disableExtrapolation() {
    QuantLibJNI.CapFloorTermVolatilityStructureHandle_disableExtrapolation__SWIG_1(swigCPtr, this);
  }
