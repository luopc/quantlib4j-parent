...
public class QuantLib {
  ...
  public static Date yearFractionToDate(DayCounter dayCounter, Date referenceDate, double t) {
    return new Date(QuantLibJNI.yearFractionToDate(DayCounter.getCPtr(dayCounter), dayCounter, Date.getCPtr(referenceDate), referenceDate, t), true);
  }
  ...
  public static Matrix CholeskyDecomposition(Matrix m, boolean flexible) {
    return new Matrix(QuantLibJNI.CholeskyDecomposition__SWIG_0(Matrix.getCPtr(m), m, flexible), true);
  }

  public static Matrix CholeskyDecomposition(Matrix m) {
    return new Matrix(QuantLibJNI.CholeskyDecomposition__SWIG_1(Matrix.getCPtr(m), m), true);
  }

  public static Array CholeskySolveFor(Matrix L, Array b) {
    return new Array(QuantLibJNI.CholeskySolveFor(Matrix.getCPtr(L), L, Array.getCPtr(b), b), true);
  }
  ...
  public static RelinkableQuoteHandle makeQuoteHandle(double value) {
    return new RelinkableQuoteHandle(QuantLibJNI.makeQuoteHandle(value), true);
  }
  ...
  public static DoubleVector sabrGuess(double k_m, double vol_m, double k_0, double vol_0, double k_p, double vol_p, double forward, double expiryTime, double beta, double shift, VolatilityType volatilityType) {
    return new DoubleVector(QuantLibJNI.sabrGuess(k_m, vol_m, k_0, vol_0, k_p, vol_p, forward, expiryTime, beta, shift, volatilityType.swigValue()), true);
  }
  ...
  public static CappedFlooredOvernightIndexedCoupon as_capped_floored_overnight_indexed_coupon(CashFlow cf) {
    long cPtr = QuantLibJNI.as_capped_floored_overnight_indexed_coupon(CashFlow.getCPtr(cf), cf);
    return (cPtr == 0) ? null : new CappedFlooredOvernightIndexedCoupon(cPtr, true);
  }

  public static MultipleResetsCoupon as_multiple_resets_coupon(CashFlow cf) {
    long cPtr = QuantLibJNI.as_multiple_resets_coupon(CashFlow.getCPtr(cf), cf);
    return (cPtr == 0) ? null : new MultipleResetsCoupon(cPtr, true);
  }

  public static void setCouponPricer(Leg arg0, EquityCashFlowPricer arg1) {
    QuantLibJNI.setCouponPricer__SWIG_1(Leg.getCPtr(arg0), arg0, EquityCashFlowPricer.getCPtr(arg1), arg1);
  }

  public static Leg FixedRateLeg(Schedule schedule, DayCounter dayCount, DoubleVector nominals, DoubleVector couponRates, BusinessDayConvention paymentAdjustment, DayCounter firstPeriodDayCount, Period exCouponPeriod, Calendar exCouponCalendar, BusinessDayConvention exCouponConvention, boolean exCouponEndOfMonth, Calendar paymentCalendar, int paymentLag, Compounding compounding, Frequency compoundingFrequency, InterestRateVector interestRates) {
    return new Leg(QuantLibJNI.FixedRateLeg__SWIG_0(Schedule.getCPtr(schedule), schedule, DayCounter.getCPtr(dayCount), dayCount, DoubleVector.getCPtr(nominals), nominals, DoubleVector.getCPtr(couponRates), couponRates, paymentAdjustment.swigValue(), DayCounter.getCPtr(firstPeriodDayCount), firstPeriodDayCount, Period.getCPtr(exCouponPeriod), exCouponPeriod, Calendar.getCPtr(exCouponCalendar), exCouponCalendar, exCouponConvention.swigValue(), exCouponEndOfMonth, Calendar.getCPtr(paymentCalendar), paymentCalendar, paymentLag, compounding.swigValue(), compoundingFrequency.swigValue(), InterestRateVector.getCPtr(interestRates), interestRates), true);
  }

  public static Leg FixedRateLeg(Schedule schedule, DayCounter dayCount, DoubleVector nominals, DoubleVector couponRates, BusinessDayConvention paymentAdjustment, DayCounter firstPeriodDayCount, Period exCouponPeriod, Calendar exCouponCalendar, BusinessDayConvention exCouponConvention, boolean exCouponEndOfMonth, Calendar paymentCalendar, int paymentLag, Compounding compounding, Frequency compoundingFrequency) {
  ...
  public static Leg FixedRateLeg(Schedule schedule, DayCounter dayCount, DoubleVector nominals, DoubleVector couponRates, BusinessDayConvention paymentAdjustment, DayCounter firstPeriodDayCount, Period exCouponPeriod, Calendar exCouponCalendar, BusinessDayConvention exCouponConvention, boolean exCouponEndOfMonth, Calendar paymentCalendar, int paymentLag, Compounding compounding) {
  ...
  public static Leg FixedRateLeg(Schedule schedule, DayCounter dayCount, DoubleVector nominals, DoubleVector couponRates, BusinessDayConvention paymentAdjustment, DayCounter firstPeriodDayCount, Period exCouponPeriod, Calendar exCouponCalendar, BusinessDayConvention exCouponConvention, boolean exCouponEndOfMonth, Calendar paymentCalendar, int paymentLag) {
  ...
  public static Leg FixedRateLeg(Schedule schedule, DayCounter dayCount, DoubleVector nominals, DoubleVector couponRates, BusinessDayConvention paymentAdjustment, DayCounter firstPeriodDayCount, Period exCouponPeriod) {
    return new Leg(QuantLibJNI.FixedRateLeg__SWIG_8(Schedule.getCPtr(schedule), schedule, DayCounter.getCPtr(dayCount), dayCount, DoubleVector.getCPtr(nominals), nominals, DoubleVector.getCPtr(couponRates), couponRates, paymentAdjustment.swigValue(), DayCounter.getCPtr(firstPeriodDayCount), firstPeriodDayCount, Period.getCPtr(exCouponPeriod), exCouponPeriod), true);
  }
  ...
  public static Leg FixedRateLeg(Schedule schedule, DayCounter dayCount, DoubleVector nominals, DoubleVector couponRates, BusinessDayConvention paymentAdjustment, DayCounter firstPeriodDayCount) {
    return new Leg(QuantLibJNI.FixedRateLeg__SWIG_9(Schedule.getCPtr(schedule), schedule, DayCounter.getCPtr(dayCount), dayCount, DoubleVector.getCPtr(nominals), nominals, DoubleVector.getCPtr(couponRates), couponRates, paymentAdjustment.swigValue(), DayCounter.getCPtr(firstPeriodDayCount), firstPeriodDayCount), true);
  }
  ...
  public static Leg FixedRateLeg(Schedule schedule, DayCounter dayCount, DoubleVector nominals, DoubleVector couponRates, BusinessDayConvention paymentAdjustment) {
    return new Leg(QuantLibJNI.FixedRateLeg__SWIG_10(Schedule.getCPtr(schedule), schedule, DayCounter.getCPtr(dayCount), dayCount, DoubleVector.getCPtr(nominals), nominals, DoubleVector.getCPtr(couponRates), couponRates, paymentAdjustment.swigValue()), true);
  }

  public static Leg FixedRateLeg(Schedule schedule, DayCounter dayCount, DoubleVector nominals, DoubleVector couponRates) {
    return new Leg(QuantLibJNI.FixedRateLeg__SWIG_11(Schedule.getCPtr(schedule), schedule, DayCounter.getCPtr(dayCount), dayCount, DoubleVector.getCPtr(nominals), nominals, DoubleVector.getCPtr(couponRates), couponRates), true);
  }

  public static Leg FixedRateLeg(Schedule schedule, DayCounter dayCount, DoubleVector nominals) {
    return new Leg(QuantLibJNI.FixedRateLeg__SWIG_12(Schedule.getCPtr(schedule), schedule, DayCounter.getCPtr(dayCount), dayCount, DoubleVector.getCPtr(nominals), nominals), true);
  }

  public static Leg IborLeg(DoubleVector nominals, Schedule schedule, IborIndex index, DayCounter paymentDayCounter, BusinessDayConvention paymentConvention, UnsignedIntVector fixingDays, DoubleVector gearings, DoubleVector spreads, DoubleVector caps, DoubleVector floors, boolean isInArrears, Period exCouponPeriod, Calendar exCouponCalendar, BusinessDayConvention exCouponConvention, boolean exCouponEndOfMonth, Calendar paymentCalendar, int paymentLag, OptionalBool withIndexedCoupons) {
  ...
  public static Leg IborLeg(DoubleVector nominals, Schedule schedule, IborIndex index, DayCounter paymentDayCounter, BusinessDayConvention paymentConvention, UnsignedIntVector fixingDays, DoubleVector gearings, DoubleVector spreads, DoubleVector caps, DoubleVector floors, boolean isInArrears, Period exCouponPeriod, Calendar exCouponCalendar, BusinessDayConvention exCouponConvention, boolean exCouponEndOfMonth, Calendar paymentCalendar, int paymentLag) {
  ...
  public static Leg OvernightLeg(DoubleVector nominals, Schedule schedule, OvernightIndex index, DayCounter paymentDayCounter, BusinessDayConvention paymentConvention, DoubleVector gearings, DoubleVector spreads, boolean telescopicValueDates, RateAveraging.Type averagingMethod, Calendar paymentCalendar, int paymentLag, long lookbackDays, long lockoutDays, boolean applyObservationShift, boolean compoundSpreadDaily, DoubleVector caps, DoubleVector floors, boolean dailyCapFloor, boolean inArrears, boolean nakedOption, DateVector paymentDates) {
    return new Leg(QuantLibJNI.OvernightLeg__SWIG_0(DoubleVector.getCPtr(nominals), nominals, Schedule.getCPtr(schedule), schedule, OvernightIndex.getCPtr(index), index, DayCounter.getCPtr(paymentDayCounter), paymentDayCounter, paymentConvention.swigValue(), DoubleVector.getCPtr(gearings), gearings, DoubleVector.getCPtr(spreads), spreads, telescopicValueDates, averagingMethod.swigValue(), Calendar.getCPtr(paymentCalendar), paymentCalendar, paymentLag, lookbackDays, lockoutDays, applyObservationShift, compoundSpreadDaily, DoubleVector.getCPtr(caps), caps, DoubleVector.getCPtr(floors), floors, dailyCapFloor, inArrears, nakedOption, DateVector.getCPtr(paymentDates), paymentDates), true);
  }

  public static Leg OvernightLeg(DoubleVector nominals, Schedule schedule, OvernightIndex index, DayCounter paymentDayCounter, BusinessDayConvention paymentConvention, DoubleVector gearings, DoubleVector spreads, boolean telescopicValueDates, RateAveraging.Type averagingMethod, Calendar paymentCalendar, int paymentLag, long lookbackDays, long lockoutDays, boolean applyObservationShift, boolean compoundSpreadDaily, DoubleVector caps, DoubleVector floors, boolean dailyCapFloor, boolean inArrears, boolean nakedOption) {
    return new Leg(QuantLibJNI.OvernightLeg__SWIG_1(DoubleVector.getCPtr(nominals), nominals, Schedule.getCPtr(schedule), schedule, OvernightIndex.getCPtr(index), index, DayCounter.getCPtr(paymentDayCounter), paymentDayCounter, paymentConvention.swigValue(), DoubleVector.getCPtr(gearings), gearings, DoubleVector.getCPtr(spreads), spreads, telescopicValueDates, averagingMethod.swigValue(), Calendar.getCPtr(paymentCalendar), paymentCalendar, paymentLag, lookbackDays, lockoutDays, applyObservationShift, compoundSpreadDaily, DoubleVector.getCPtr(caps), caps, DoubleVector.getCPtr(floors), floors, dailyCapFloor, inArrears, nakedOption), true);
  }

  public static Leg OvernightLeg(DoubleVector nominals, Schedule schedule, OvernightIndex index, DayCounter paymentDayCounter, BusinessDayConvention paymentConvention, DoubleVector gearings, DoubleVector spreads, boolean telescopicValueDates, RateAveraging.Type averagingMethod, Calendar paymentCalendar, int paymentLag, long lookbackDays, long lockoutDays, boolean applyObservationShift, boolean compoundSpreadDaily, DoubleVector caps, DoubleVector floors, boolean dailyCapFloor, boolean inArrears) {
    return new Leg(QuantLibJNI.OvernightLeg__SWIG_2(DoubleVector.getCPtr(nominals), nominals, Schedule.getCPtr(schedule), schedule, OvernightIndex.getCPtr(index), index, DayCounter.getCPtr(paymentDayCounter), paymentDayCounter, paymentConvention.swigValue(), DoubleVector.getCPtr(gearings), gearings, DoubleVector.getCPtr(spreads), spreads, telescopicValueDates, averagingMethod.swigValue(), Calendar.getCPtr(paymentCalendar), paymentCalendar, paymentLag, lookbackDays, lockoutDays, applyObservationShift, compoundSpreadDaily, DoubleVector.getCPtr(caps), caps, DoubleVector.getCPtr(floors), floors, dailyCapFloor, inArrears), true);
  }

  public static Leg OvernightLeg(DoubleVector nominals, Schedule schedule, OvernightIndex index, DayCounter paymentDayCounter, BusinessDayConvention paymentConvention, DoubleVector gearings, DoubleVector spreads, boolean telescopicValueDates, RateAveraging.Type averagingMethod, Calendar paymentCalendar, int paymentLag, long lookbackDays, long lockoutDays, boolean applyObservationShift, boolean compoundSpreadDaily, DoubleVector caps, DoubleVector floors, boolean dailyCapFloor) {
    return new Leg(QuantLibJNI.OvernightLeg__SWIG_3(DoubleVector.getCPtr(nominals), nominals, Schedule.getCPtr(schedule), schedule, OvernightIndex.getCPtr(index), index, DayCounter.getCPtr(paymentDayCounter), paymentDayCounter, paymentConvention.swigValue(), DoubleVector.getCPtr(gearings), gearings, DoubleVector.getCPtr(spreads), spreads, telescopicValueDates, averagingMethod.swigValue(), Calendar.getCPtr(paymentCalendar), paymentCalendar, paymentLag, lookbackDays, lockoutDays, applyObservationShift, compoundSpreadDaily, DoubleVector.getCPtr(caps), caps, DoubleVector.getCPtr(floors), floors, dailyCapFloor), true);
  }
  ...
  public static Leg OvernightLeg(DoubleVector nominals, Schedule schedule, OvernightIndex index, DayCounter paymentDayCounter, BusinessDayConvention paymentConvention, DoubleVector gearings, DoubleVector spreads, boolean telescopicValueDates, RateAveraging.Type averagingMethod, Calendar paymentCalendar, int paymentLag, long lookbackDays, long lockoutDays, boolean applyObservationShift, boolean compoundSpreadDaily, DoubleVector caps) {
    return new Leg(QuantLibJNI.OvernightLeg__SWIG_5(DoubleVector.getCPtr(nominals), nominals, Schedule.getCPtr(schedule), schedule, OvernightIndex.getCPtr(index), index, DayCounter.getCPtr(paymentDayCounter), paymentDayCounter, paymentConvention.swigValue(), DoubleVector.getCPtr(gearings), gearings, DoubleVector.getCPtr(spreads), spreads, telescopicValueDates, averagingMethod.swigValue(), Calendar.getCPtr(paymentCalendar), paymentCalendar, paymentLag, lookbackDays, lockoutDays, applyObservationShift, compoundSpreadDaily, DoubleVector.getCPtr(caps), caps), true);
  }

  public static Leg OvernightLeg(DoubleVector nominals, Schedule schedule, OvernightIndex index, DayCounter paymentDayCounter, BusinessDayConvention paymentConvention, DoubleVector gearings, DoubleVector spreads, boolean telescopicValueDates, RateAveraging.Type averagingMethod, Calendar paymentCalendar, int paymentLag, long lookbackDays, long lockoutDays, boolean applyObservationShift, boolean compoundSpreadDaily) {
    return new Leg(QuantLibJNI.OvernightLeg__SWIG_6(DoubleVector.getCPtr(nominals), nominals, Schedule.getCPtr(schedule), schedule, OvernightIndex.getCPtr(index), index, DayCounter.getCPtr(paymentDayCounter), paymentDayCounter, paymentConvention.swigValue(), DoubleVector.getCPtr(gearings), gearings, DoubleVector.getCPtr(spreads), spreads, telescopicValueDates, averagingMethod.swigValue(), Calendar.getCPtr(paymentCalendar), paymentCalendar, paymentLag, lookbackDays, lockoutDays, applyObservationShift, compoundSpreadDaily), true);
  }

  public static Leg OvernightLeg(DoubleVector nominals, Schedule schedule, OvernightIndex index, DayCounter paymentDayCounter, BusinessDayConvention paymentConvention, DoubleVector gearings, DoubleVector spreads, boolean telescopicValueDates, RateAveraging.Type averagingMethod, Calendar paymentCalendar, int paymentLag, long lookbackDays, long lockoutDays, boolean applyObservationShift) {
    return new Leg(QuantLibJNI.OvernightLeg__SWIG_7(DoubleVector.getCPtr(nominals), nominals, Schedule.getCPtr(schedule), schedule, OvernightIndex.getCPtr(index), index, DayCounter.getCPtr(paymentDayCounter), paymentDayCounter, paymentConvention.swigValue(), DoubleVector.getCPtr(gearings), gearings, DoubleVector.getCPtr(spreads), spreads, telescopicValueDates, averagingMethod.swigValue(), Calendar.getCPtr(paymentCalendar), paymentCalendar, paymentLag, lookbackDays, lockoutDays, applyObservationShift), true);
  }

  public static Leg OvernightLeg(DoubleVector nominals, Schedule schedule, OvernightIndex index, DayCounter paymentDayCounter, BusinessDayConvention paymentConvention, DoubleVector gearings, DoubleVector spreads, boolean telescopicValueDates, RateAveraging.Type averagingMethod, Calendar paymentCalendar, int paymentLag, long lookbackDays, long lockoutDays) {
    return new Leg(QuantLibJNI.OvernightLeg__SWIG_8(DoubleVector.getCPtr(nominals), nominals, Schedule.getCPtr(schedule), schedule, OvernightIndex.getCPtr(index), index, DayCounter.getCPtr(paymentDayCounter), paymentDayCounter, paymentConvention.swigValue(), DoubleVector.getCPtr(gearings), gearings, DoubleVector.getCPtr(spreads), spreads, telescopicValueDates, averagingMethod.swigValue(), Calendar.getCPtr(paymentCalendar), paymentCalendar, paymentLag, lookbackDays, lockoutDays), true);
  }

  public static Leg OvernightLeg(DoubleVector nominals, Schedule schedule, OvernightIndex index, DayCounter paymentDayCounter, BusinessDayConvention paymentConvention, DoubleVector gearings, DoubleVector spreads, boolean telescopicValueDates, RateAveraging.Type averagingMethod, Calendar paymentCalendar, int paymentLag, long lookbackDays) {
    return new Leg(QuantLibJNI.OvernightLeg__SWIG_9(DoubleVector.getCPtr(nominals), nominals, Schedule.getCPtr(schedule), schedule, OvernightIndex.getCPtr(index), index, DayCounter.getCPtr(paymentDayCounter), paymentDayCounter, paymentConvention.swigValue(), DoubleVector.getCPtr(gearings), gearings, DoubleVector.getCPtr(spreads), spreads, telescopicValueDates, averagingMethod.swigValue(), Calendar.getCPtr(paymentCalendar), paymentCalendar, paymentLag, lookbackDays), true);
  }

  public static Leg OvernightLeg(DoubleVector nominals, Schedule schedule, OvernightIndex index, DayCounter paymentDayCounter, BusinessDayConvention paymentConvention, DoubleVector gearings, DoubleVector spreads, boolean telescopicValueDates, RateAveraging.Type averagingMethod, Calendar paymentCalendar, int paymentLag) {
    return new Leg(QuantLibJNI.OvernightLeg__SWIG_10(DoubleVector.getCPtr(nominals), nominals, Schedule.getCPtr(schedule), schedule, OvernightIndex.getCPtr(index), index, DayCounter.getCPtr(paymentDayCounter), paymentDayCounter, paymentConvention.swigValue(), DoubleVector.getCPtr(gearings), gearings, DoubleVector.getCPtr(spreads), spreads, telescopicValueDates, averagingMethod.swigValue(), Calendar.getCPtr(paymentCalendar), paymentCalendar, paymentLag), true);
  }
  ...
  public static Leg OvernightLeg(DoubleVector nominals, Schedule schedule, OvernightIndex index, DayCounter paymentDayCounter, BusinessDayConvention paymentConvention, DoubleVector gearings) {
    return new Leg(QuantLibJNI.OvernightLeg__SWIG_15(DoubleVector.getCPtr(nominals), nominals, Schedule.getCPtr(schedule), schedule, OvernightIndex.getCPtr(index), index, DayCounter.getCPtr(paymentDayCounter), paymentDayCounter, paymentConvention.swigValue(), DoubleVector.getCPtr(gearings), gearings), true);
  }
  ...
  public static Leg OvernightLeg(DoubleVector nominals, Schedule schedule, OvernightIndex index, DayCounter paymentDayCounter, BusinessDayConvention paymentConvention) {
    return new Leg(QuantLibJNI.OvernightLeg__SWIG_16(DoubleVector.getCPtr(nominals), nominals, Schedule.getCPtr(schedule), schedule, OvernightIndex.getCPtr(index), index, DayCounter.getCPtr(paymentDayCounter), paymentDayCounter, paymentConvention.swigValue()), true);
  }

  public static Leg OvernightLeg(DoubleVector nominals, Schedule schedule, OvernightIndex index, DayCounter paymentDayCounter) {
    return new Leg(QuantLibJNI.OvernightLeg__SWIG_17(DoubleVector.getCPtr(nominals), nominals, Schedule.getCPtr(schedule), schedule, OvernightIndex.getCPtr(index), index, DayCounter.getCPtr(paymentDayCounter), paymentDayCounter), true);
  }

  public static Leg OvernightLeg(DoubleVector nominals, Schedule schedule, OvernightIndex index) {
    return new Leg(QuantLibJNI.OvernightLeg__SWIG_18(DoubleVector.getCPtr(nominals), nominals, Schedule.getCPtr(schedule), schedule, OvernightIndex.getCPtr(index), index), true);
  }

  public static Leg CmsLeg(DoubleVector nominals, Schedule schedule, SwapIndex index, DayCounter paymentDayCounter, BusinessDayConvention paymentConvention, UnsignedIntVector fixingDays, DoubleVector gearings, DoubleVector spreads, DoubleVector caps, DoubleVector floors, boolean isInArrears, Period exCouponPeriod, Calendar exCouponCalendar, BusinessDayConvention exCouponConvention, boolean exCouponEndOfMonth, BusinessDayConvention fixingConvention) {
    return new Leg(QuantLibJNI.CmsLeg__SWIG_0(DoubleVector.getCPtr(nominals), nominals, Schedule.getCPtr(schedule), schedule, SwapIndex.getCPtr(index), index, DayCounter.getCPtr(paymentDayCounter), paymentDayCounter, paymentConvention.swigValue(), UnsignedIntVector.getCPtr(fixingDays), fixingDays, DoubleVector.getCPtr(gearings), gearings, DoubleVector.getCPtr(spreads), spreads, DoubleVector.getCPtr(caps), caps, DoubleVector.getCPtr(floors), floors, isInArrears, Period.getCPtr(exCouponPeriod), exCouponPeriod, Calendar.getCPtr(exCouponCalendar), exCouponCalendar, exCouponConvention.swigValue(), exCouponEndOfMonth, fixingConvention.swigValue()), true);
  }
  ...
  public static Leg CmsLeg(DoubleVector nominals, Schedule schedule, SwapIndex index, DayCounter paymentDayCounter, BusinessDayConvention paymentConvention, UnsignedIntVector fixingDays, DoubleVector gearings) {
    return new Leg(QuantLibJNI.CmsLeg__SWIG_9(DoubleVector.getCPtr(nominals), nominals, Schedule.getCPtr(schedule), schedule, SwapIndex.getCPtr(index), index, DayCounter.getCPtr(paymentDayCounter), paymentDayCounter, paymentConvention.swigValue(), UnsignedIntVector.getCPtr(fixingDays), fixingDays, DoubleVector.getCPtr(gearings), gearings), true);
  }
  ...
  public static Leg CmsLeg(DoubleVector nominals, Schedule schedule, SwapIndex index, DayCounter paymentDayCounter, BusinessDayConvention paymentConvention, UnsignedIntVector fixingDays) {
    return new Leg(QuantLibJNI.CmsLeg__SWIG_10(DoubleVector.getCPtr(nominals), nominals, Schedule.getCPtr(schedule), schedule, SwapIndex.getCPtr(index), index, DayCounter.getCPtr(paymentDayCounter), paymentDayCounter, paymentConvention.swigValue(), UnsignedIntVector.getCPtr(fixingDays), fixingDays), true);
  }
  ...
  public static Leg CmsLeg(DoubleVector nominals, Schedule schedule, SwapIndex index, DayCounter paymentDayCounter, BusinessDayConvention paymentConvention) {
    return new Leg(QuantLibJNI.CmsLeg__SWIG_11(DoubleVector.getCPtr(nominals), nominals, Schedule.getCPtr(schedule), schedule, SwapIndex.getCPtr(index), index, DayCounter.getCPtr(paymentDayCounter), paymentDayCounter, paymentConvention.swigValue()), true);
  }

  public static Leg CmsLeg(DoubleVector nominals, Schedule schedule, SwapIndex index, DayCounter paymentDayCounter) {
    return new Leg(QuantLibJNI.CmsLeg__SWIG_12(DoubleVector.getCPtr(nominals), nominals, Schedule.getCPtr(schedule), schedule, SwapIndex.getCPtr(index), index, DayCounter.getCPtr(paymentDayCounter), paymentDayCounter), true);
  }

  public static Leg CmsLeg(DoubleVector nominals, Schedule schedule, SwapIndex index) {
    return new Leg(QuantLibJNI.CmsLeg__SWIG_13(DoubleVector.getCPtr(nominals), nominals, Schedule.getCPtr(schedule), schedule, SwapIndex.getCPtr(index), index), true);
  }
  ...
  public static Leg MultipleResetsLeg(Schedule fullResetSchedule, IborIndex index, long resetsPerCoupon, DoubleVector nominals, DayCounter paymentDayCounter, BusinessDayConvention paymentConvention, Calendar paymentCalendar, int paymentLag, UnsignedIntVector fixingDays, DoubleVector gearings, DoubleVector couponSpreads, DoubleVector rateSpreads, Period exCouponPeriod, Calendar exCouponCalendar, BusinessDayConvention exCouponConvention, boolean exCouponEndOfMonth, RateAveraging.Type averagingMethod) {
    return new Leg(QuantLibJNI.MultipleResetsLeg__SWIG_0(Schedule.getCPtr(fullResetSchedule), fullResetSchedule, IborIndex.getCPtr(index), index, resetsPerCoupon, DoubleVector.getCPtr(nominals), nominals, DayCounter.getCPtr(paymentDayCounter), paymentDayCounter, paymentConvention.swigValue(), Calendar.getCPtr(paymentCalendar), paymentCalendar, paymentLag, UnsignedIntVector.getCPtr(fixingDays), fixingDays, DoubleVector.getCPtr(gearings), gearings, DoubleVector.getCPtr(couponSpreads), couponSpreads, DoubleVector.getCPtr(rateSpreads), rateSpreads, Period.getCPtr(exCouponPeriod), exCouponPeriod, Calendar.getCPtr(exCouponCalendar), exCouponCalendar, exCouponConvention.swigValue(), exCouponEndOfMonth, averagingMethod.swigValue()), true);
  }
  ...
  public static Leg MultipleResetsLeg(Schedule fullResetSchedule, IborIndex index, long resetsPerCoupon, DoubleVector nominals, DayCounter paymentDayCounter, BusinessDayConvention paymentConvention, Calendar paymentCalendar, int paymentLag, UnsignedIntVector fixingDays, DoubleVector gearings, DoubleVector couponSpreads, DoubleVector rateSpreads, Period exCouponPeriod, Calendar exCouponCalendar, BusinessDayConvention exCouponConvention, boolean exCouponEndOfMonth) {
    return new Leg(QuantLibJNI.MultipleResetsLeg__SWIG_1(Schedule.getCPtr(fullResetSchedule), fullResetSchedule, IborIndex.getCPtr(index), index, resetsPerCoupon, DoubleVector.getCPtr(nominals), nominals, DayCounter.getCPtr(paymentDayCounter), paymentDayCounter, paymentConvention.swigValue(), Calendar.getCPtr(paymentCalendar), paymentCalendar, paymentLag, UnsignedIntVector.getCPtr(fixingDays), fixingDays, DoubleVector.getCPtr(gearings), gearings, DoubleVector.getCPtr(couponSpreads), couponSpreads, DoubleVector.getCPtr(rateSpreads), rateSpreads, Period.getCPtr(exCouponPeriod), exCouponPeriod, Calendar.getCPtr(exCouponCalendar), exCouponCalendar, exCouponConvention.swigValue(), exCouponEndOfMonth), true);
  }

  public static Leg MultipleResetsLeg(Schedule fullResetSchedule, IborIndex index, long resetsPerCoupon, DoubleVector nominals, DayCounter paymentDayCounter, BusinessDayConvention paymentConvention, Calendar paymentCalendar, int paymentLag, UnsignedIntVector fixingDays, DoubleVector gearings, DoubleVector couponSpreads, DoubleVector rateSpreads, Period exCouponPeriod, Calendar exCouponCalendar, BusinessDayConvention exCouponConvention) {
    return new Leg(QuantLibJNI.MultipleResetsLeg__SWIG_2(Schedule.getCPtr(fullResetSchedule), fullResetSchedule, IborIndex.getCPtr(index), index, resetsPerCoupon, DoubleVector.getCPtr(nominals), nominals, DayCounter.getCPtr(paymentDayCounter), paymentDayCounter, paymentConvention.swigValue(), Calendar.getCPtr(paymentCalendar), paymentCalendar, paymentLag, UnsignedIntVector.getCPtr(fixingDays), fixingDays, DoubleVector.getCPtr(gearings), gearings, DoubleVector.getCPtr(couponSpreads), couponSpreads, DoubleVector.getCPtr(rateSpreads), rateSpreads, Period.getCPtr(exCouponPeriod), exCouponPeriod, Calendar.getCPtr(exCouponCalendar), exCouponCalendar, exCouponConvention.swigValue()), true);
  }

  public static Leg MultipleResetsLeg(Schedule fullResetSchedule, IborIndex index, long resetsPerCoupon, DoubleVector nominals, DayCounter paymentDayCounter, BusinessDayConvention paymentConvention, Calendar paymentCalendar, int paymentLag, UnsignedIntVector fixingDays, DoubleVector gearings, DoubleVector couponSpreads, DoubleVector rateSpreads, Period exCouponPeriod, Calendar exCouponCalendar) {
    return new Leg(QuantLibJNI.MultipleResetsLeg__SWIG_3(Schedule.getCPtr(fullResetSchedule), fullResetSchedule, IborIndex.getCPtr(index), index, resetsPerCoupon, DoubleVector.getCPtr(nominals), nominals, DayCounter.getCPtr(paymentDayCounter), paymentDayCounter, paymentConvention.swigValue(), Calendar.getCPtr(paymentCalendar), paymentCalendar, paymentLag, UnsignedIntVector.getCPtr(fixingDays), fixingDays, DoubleVector.getCPtr(gearings), gearings, DoubleVector.getCPtr(couponSpreads), couponSpreads, DoubleVector.getCPtr(rateSpreads), rateSpreads, Period.getCPtr(exCouponPeriod), exCouponPeriod, Calendar.getCPtr(exCouponCalendar), exCouponCalendar), true);
  }

  public static Leg MultipleResetsLeg(Schedule fullResetSchedule, IborIndex index, long resetsPerCoupon, DoubleVector nominals, DayCounter paymentDayCounter, BusinessDayConvention paymentConvention, Calendar paymentCalendar, int paymentLag, UnsignedIntVector fixingDays, DoubleVector gearings, DoubleVector couponSpreads, DoubleVector rateSpreads, Period exCouponPeriod) {
    return new Leg(QuantLibJNI.MultipleResetsLeg__SWIG_4(Schedule.getCPtr(fullResetSchedule), fullResetSchedule, IborIndex.getCPtr(index), index, resetsPerCoupon, DoubleVector.getCPtr(nominals), nominals, DayCounter.getCPtr(paymentDayCounter), paymentDayCounter, paymentConvention.swigValue(), Calendar.getCPtr(paymentCalendar), paymentCalendar, paymentLag, UnsignedIntVector.getCPtr(fixingDays), fixingDays, DoubleVector.getCPtr(gearings), gearings, DoubleVector.getCPtr(couponSpreads), couponSpreads, DoubleVector.getCPtr(rateSpreads), rateSpreads, Period.getCPtr(exCouponPeriod), exCouponPeriod), true);
  }

  public static Leg MultipleResetsLeg(Schedule fullResetSchedule, IborIndex index, long resetsPerCoupon, DoubleVector nominals, DayCounter paymentDayCounter, BusinessDayConvention paymentConvention, Calendar paymentCalendar, int paymentLag, UnsignedIntVector fixingDays, DoubleVector gearings, DoubleVector couponSpreads, DoubleVector rateSpreads) {
    return new Leg(QuantLibJNI.MultipleResetsLeg__SWIG_5(Schedule.getCPtr(fullResetSchedule), fullResetSchedule, IborIndex.getCPtr(index), index, resetsPerCoupon, DoubleVector.getCPtr(nominals), nominals, DayCounter.getCPtr(paymentDayCounter), paymentDayCounter, paymentConvention.swigValue(), Calendar.getCPtr(paymentCalendar), paymentCalendar, paymentLag, UnsignedIntVector.getCPtr(fixingDays), fixingDays, DoubleVector.getCPtr(gearings), gearings, DoubleVector.getCPtr(couponSpreads), couponSpreads, DoubleVector.getCPtr(rateSpreads), rateSpreads), true);
  }

  public static Leg MultipleResetsLeg(Schedule fullResetSchedule, IborIndex index, long resetsPerCoupon, DoubleVector nominals, DayCounter paymentDayCounter, BusinessDayConvention paymentConvention, Calendar paymentCalendar, int paymentLag, UnsignedIntVector fixingDays, DoubleVector gearings, DoubleVector couponSpreads) {
    return new Leg(QuantLibJNI.MultipleResetsLeg__SWIG_6(Schedule.getCPtr(fullResetSchedule), fullResetSchedule, IborIndex.getCPtr(index), index, resetsPerCoupon, DoubleVector.getCPtr(nominals), nominals, DayCounter.getCPtr(paymentDayCounter), paymentDayCounter, paymentConvention.swigValue(), Calendar.getCPtr(paymentCalendar), paymentCalendar, paymentLag, UnsignedIntVector.getCPtr(fixingDays), fixingDays, DoubleVector.getCPtr(gearings), gearings, DoubleVector.getCPtr(couponSpreads), couponSpreads), true);
  }

  public static Leg MultipleResetsLeg(Schedule fullResetSchedule, IborIndex index, long resetsPerCoupon, DoubleVector nominals, DayCounter paymentDayCounter, BusinessDayConvention paymentConvention, Calendar paymentCalendar, int paymentLag, UnsignedIntVector fixingDays, DoubleVector gearings) {
    return new Leg(QuantLibJNI.MultipleResetsLeg__SWIG_7(Schedule.getCPtr(fullResetSchedule), fullResetSchedule, IborIndex.getCPtr(index), index, resetsPerCoupon, DoubleVector.getCPtr(nominals), nominals, DayCounter.getCPtr(paymentDayCounter), paymentDayCounter, paymentConvention.swigValue(), Calendar.getCPtr(paymentCalendar), paymentCalendar, paymentLag, UnsignedIntVector.getCPtr(fixingDays), fixingDays, DoubleVector.getCPtr(gearings), gearings), true);
  }

  public static Leg MultipleResetsLeg(Schedule fullResetSchedule, IborIndex index, long resetsPerCoupon, DoubleVector nominals, DayCounter paymentDayCounter, BusinessDayConvention paymentConvention, Calendar paymentCalendar, int paymentLag, UnsignedIntVector fixingDays) {
    return new Leg(QuantLibJNI.MultipleResetsLeg__SWIG_8(Schedule.getCPtr(fullResetSchedule), fullResetSchedule, IborIndex.getCPtr(index), index, resetsPerCoupon, DoubleVector.getCPtr(nominals), nominals, DayCounter.getCPtr(paymentDayCounter), paymentDayCounter, paymentConvention.swigValue(), Calendar.getCPtr(paymentCalendar), paymentCalendar, paymentLag, UnsignedIntVector.getCPtr(fixingDays), fixingDays), true);
  }

  public static Leg MultipleResetsLeg(Schedule fullResetSchedule, IborIndex index, long resetsPerCoupon, DoubleVector nominals, DayCounter paymentDayCounter, BusinessDayConvention paymentConvention, Calendar paymentCalendar, int paymentLag) {
    return new Leg(QuantLibJNI.MultipleResetsLeg__SWIG_9(Schedule.getCPtr(fullResetSchedule), fullResetSchedule, IborIndex.getCPtr(index), index, resetsPerCoupon, DoubleVector.getCPtr(nominals), nominals, DayCounter.getCPtr(paymentDayCounter), paymentDayCounter, paymentConvention.swigValue(), Calendar.getCPtr(paymentCalendar), paymentCalendar, paymentLag), true);
  }

  public static Leg MultipleResetsLeg(Schedule fullResetSchedule, IborIndex index, long resetsPerCoupon, DoubleVector nominals, DayCounter paymentDayCounter, BusinessDayConvention paymentConvention, Calendar paymentCalendar) {
    return new Leg(QuantLibJNI.MultipleResetsLeg__SWIG_10(Schedule.getCPtr(fullResetSchedule), fullResetSchedule, IborIndex.getCPtr(index), index, resetsPerCoupon, DoubleVector.getCPtr(nominals), nominals, DayCounter.getCPtr(paymentDayCounter), paymentDayCounter, paymentConvention.swigValue(), Calendar.getCPtr(paymentCalendar), paymentCalendar), true);
  }

  public static Leg MultipleResetsLeg(Schedule fullResetSchedule, IborIndex index, long resetsPerCoupon, DoubleVector nominals, DayCounter paymentDayCounter, BusinessDayConvention paymentConvention) {
    return new Leg(QuantLibJNI.MultipleResetsLeg__SWIG_11(Schedule.getCPtr(fullResetSchedule), fullResetSchedule, IborIndex.getCPtr(index), index, resetsPerCoupon, DoubleVector.getCPtr(nominals), nominals, DayCounter.getCPtr(paymentDayCounter), paymentDayCounter, paymentConvention.swigValue()), true);
  }

  public static Leg MultipleResetsLeg(Schedule fullResetSchedule, IborIndex index, long resetsPerCoupon, DoubleVector nominals, DayCounter paymentDayCounter) {
    return new Leg(QuantLibJNI.MultipleResetsLeg__SWIG_12(Schedule.getCPtr(fullResetSchedule), fullResetSchedule, IborIndex.getCPtr(index), index, resetsPerCoupon, DoubleVector.getCPtr(nominals), nominals, DayCounter.getCPtr(paymentDayCounter), paymentDayCounter), true);
  }

  public static Leg MultipleResetsLeg(Schedule fullResetSchedule, IborIndex index, long resetsPerCoupon, DoubleVector nominals) {
    return new Leg(QuantLibJNI.MultipleResetsLeg__SWIG_13(Schedule.getCPtr(fullResetSchedule), fullResetSchedule, IborIndex.getCPtr(index), index, resetsPerCoupon, DoubleVector.getCPtr(nominals), nominals), true);
  }
  ...
  public static Leg RangeAccrualLeg(DoubleVector nominals, Schedule schedule, IborIndex index, DayCounter paymentDayCounter, BusinessDayConvention paymentConvention, UnsignedIntVector fixingDays, DoubleVector gearings, DoubleVector spreads, DoubleVector lowerTriggers, DoubleVector upperTriggers, Period observationTenor, BusinessDayConvention observationConvention) {
    return new Leg(QuantLibJNI.RangeAccrualLeg__SWIG_0(DoubleVector.getCPtr(nominals), nominals, Schedule.getCPtr(schedule), schedule, IborIndex.getCPtr(index), index, DayCounter.getCPtr(paymentDayCounter), paymentDayCounter, paymentConvention.swigValue(), UnsignedIntVector.getCPtr(fixingDays), fixingDays, DoubleVector.getCPtr(gearings), gearings, DoubleVector.getCPtr(spreads), spreads, DoubleVector.getCPtr(lowerTriggers), lowerTriggers, DoubleVector.getCPtr(upperTriggers), upperTriggers, Period.getCPtr(observationTenor), observationTenor, observationConvention.swigValue()), true);
  }

  public static Leg RangeAccrualLeg(DoubleVector nominals, Schedule schedule, IborIndex index, DayCounter paymentDayCounter, BusinessDayConvention paymentConvention, UnsignedIntVector fixingDays, DoubleVector gearings, DoubleVector spreads, DoubleVector lowerTriggers, DoubleVector upperTriggers, Period observationTenor) {
    return new Leg(QuantLibJNI.RangeAccrualLeg__SWIG_1(DoubleVector.getCPtr(nominals), nominals, Schedule.getCPtr(schedule), schedule, IborIndex.getCPtr(index), index, DayCounter.getCPtr(paymentDayCounter), paymentDayCounter, paymentConvention.swigValue(), UnsignedIntVector.getCPtr(fixingDays), fixingDays, DoubleVector.getCPtr(gearings), gearings, DoubleVector.getCPtr(spreads), spreads, DoubleVector.getCPtr(lowerTriggers), lowerTriggers, DoubleVector.getCPtr(upperTriggers), upperTriggers, Period.getCPtr(observationTenor), observationTenor), true);
  }
  ...
  public static Leg RangeAccrualLeg(DoubleVector nominals, Schedule schedule, IborIndex index, DayCounter paymentDayCounter, BusinessDayConvention paymentConvention, UnsignedIntVector fixingDays, DoubleVector gearings, DoubleVector spreads, DoubleVector lowerTriggers, DoubleVector upperTriggers) {
    return new Leg(QuantLibJNI.RangeAccrualLeg__SWIG_2(DoubleVector.getCPtr(nominals), nominals, Schedule.getCPtr(schedule), schedule, IborIndex.getCPtr(index), index, DayCounter.getCPtr(paymentDayCounter), paymentDayCounter, paymentConvention.swigValue(), UnsignedIntVector.getCPtr(fixingDays), fixingDays, DoubleVector.getCPtr(gearings), gearings, DoubleVector.getCPtr(spreads), spreads, DoubleVector.getCPtr(lowerTriggers), lowerTriggers, DoubleVector.getCPtr(upperTriggers), upperTriggers), true);
  }
  ...
  public static Leg RangeAccrualLeg(DoubleVector nominals, Schedule schedule, IborIndex index, DayCounter paymentDayCounter, BusinessDayConvention paymentConvention, UnsignedIntVector fixingDays, DoubleVector gearings, DoubleVector spreads, DoubleVector lowerTriggers) {
    return new Leg(QuantLibJNI.RangeAccrualLeg__SWIG_3(DoubleVector.getCPtr(nominals), nominals, Schedule.getCPtr(schedule), schedule, IborIndex.getCPtr(index), index, DayCounter.getCPtr(paymentDayCounter), paymentDayCounter, paymentConvention.swigValue(), UnsignedIntVector.getCPtr(fixingDays), fixingDays, DoubleVector.getCPtr(gearings), gearings, DoubleVector.getCPtr(spreads), spreads, DoubleVector.getCPtr(lowerTriggers), lowerTriggers), true);
  }
  ...
  public static Leg RangeAccrualLeg(DoubleVector nominals, Schedule schedule, IborIndex index, DayCounter paymentDayCounter, BusinessDayConvention paymentConvention, UnsignedIntVector fixingDays, DoubleVector gearings, DoubleVector spreads) {
    return new Leg(QuantLibJNI.RangeAccrualLeg__SWIG_4(DoubleVector.getCPtr(nominals), nominals, Schedule.getCPtr(schedule), schedule, IborIndex.getCPtr(index), index, DayCounter.getCPtr(paymentDayCounter), paymentDayCounter, paymentConvention.swigValue(), UnsignedIntVector.getCPtr(fixingDays), fixingDays, DoubleVector.getCPtr(gearings), gearings, DoubleVector.getCPtr(spreads), spreads), true);
  }
  ...
  public static Leg RangeAccrualLeg(DoubleVector nominals, Schedule schedule, IborIndex index, DayCounter paymentDayCounter, BusinessDayConvention paymentConvention, UnsignedIntVector fixingDays, DoubleVector gearings) {
    return new Leg(QuantLibJNI.RangeAccrualLeg__SWIG_5(DoubleVector.getCPtr(nominals), nominals, Schedule.getCPtr(schedule), schedule, IborIndex.getCPtr(index), index, DayCounter.getCPtr(paymentDayCounter), paymentDayCounter, paymentConvention.swigValue(), UnsignedIntVector.getCPtr(fixingDays), fixingDays, DoubleVector.getCPtr(gearings), gearings), true);
  }
  ...
  public static Leg RangeAccrualLeg(DoubleVector nominals, Schedule schedule, IborIndex index, DayCounter paymentDayCounter, BusinessDayConvention paymentConvention, UnsignedIntVector fixingDays) {
    return new Leg(QuantLibJNI.RangeAccrualLeg__SWIG_6(DoubleVector.getCPtr(nominals), nominals, Schedule.getCPtr(schedule), schedule, IborIndex.getCPtr(index), index, DayCounter.getCPtr(paymentDayCounter), paymentDayCounter, paymentConvention.swigValue(), UnsignedIntVector.getCPtr(fixingDays), fixingDays), true);
  }
  ...
  public static Leg RangeAccrualLeg(DoubleVector nominals, Schedule schedule, IborIndex index, DayCounter paymentDayCounter, BusinessDayConvention paymentConvention) {
    return new Leg(QuantLibJNI.RangeAccrualLeg__SWIG_7(DoubleVector.getCPtr(nominals), nominals, Schedule.getCPtr(schedule), schedule, IborIndex.getCPtr(index), index, DayCounter.getCPtr(paymentDayCounter), paymentDayCounter, paymentConvention.swigValue()), true);
  }

  public static Leg RangeAccrualLeg(DoubleVector nominals, Schedule schedule, IborIndex index, DayCounter paymentDayCounter) {
    return new Leg(QuantLibJNI.RangeAccrualLeg__SWIG_8(DoubleVector.getCPtr(nominals), nominals, Schedule.getCPtr(schedule), schedule, IborIndex.getCPtr(index), index, DayCounter.getCPtr(paymentDayCounter), paymentDayCounter), true);
  }

  public static Leg RangeAccrualLeg(DoubleVector nominals, Schedule schedule, IborIndex index) {
    return new Leg(QuantLibJNI.RangeAccrualLeg__SWIG_9(DoubleVector.getCPtr(nominals), nominals, Schedule.getCPtr(schedule), schedule, IborIndex.getCPtr(index), index), true);
  }

  public static DividendSchedule DividendVector(DateVector dividendDates, DoubleVector dividends) {
    return new DividendSchedule(QuantLibJNI.DividendVector(DateVector.getCPtr(dividendDates), dividendDates, DoubleVector.getCPtr(dividends), dividends), true);
  }
  ...
  public static double bachelierBlackFormulaImpliedVolChoi(Option.Type optionType, double strike, double forward, double tte, double bachelierPrice, double discount) {
    return QuantLibJNI.bachelierBlackFormulaImpliedVolChoi__SWIG_0(optionType.swigValue(), strike, forward, tte, bachelierPrice, discount);
  }
  ...
  public static double bachelierBlackFormulaImpliedVolChoi(Option.Type optionType, double strike, double forward, double tte, double bachelierPrice) {
    return QuantLibJNI.bachelierBlackFormulaImpliedVolChoi__SWIG_1(optionType.swigValue(), strike, forward, tte, bachelierPrice);
  }
  ...
  public static void simplifyNotificationGraph(Swap swap, boolean unregisterCoupons) {
    QuantLibJNI.simplifyNotificationGraph__SWIG_0(Swap.getCPtr(swap), swap, unregisterCoupons);
  }

  public static void simplifyNotificationGraph(Swap swap) {
    QuantLibJNI.simplifyNotificationGraph__SWIG_1(Swap.getCPtr(swap), swap);
  }
  ...
  public static MultiplicativePriceSeasonality as_multiplicative_price_seasonality(Seasonality seasonality) {
    long cPtr = QuantLibJNI.as_multiplicative_price_seasonality(Seasonality.getCPtr(seasonality), seasonality);
    return (cPtr == 0) ? null : new MultiplicativePriceSeasonality(cPtr, true);
  }
  ...
  public static Leg CPILeg(DoubleVector nominals, Schedule schedule, ZeroInflationIndex index, double baseCPI, Period observationLag, DayCounter paymentDayCounter, BusinessDayConvention paymentConvention, DoubleVector fixedRates, DoubleVector caps, DoubleVector floors, Period exCouponPeriod, Calendar exCouponCalendar, BusinessDayConvention exCouponConvention, boolean exCouponEndOfMonth, Calendar paymentCalendar, boolean growthOnly, CPI.InterpolationType observationInterpolation) {
    return new Leg(QuantLibJNI.CPILeg__SWIG_0(DoubleVector.getCPtr(nominals), nominals, Schedule.getCPtr(schedule), schedule, ZeroInflationIndex.getCPtr(index), index, baseCPI, Period.getCPtr(observationLag), observationLag, DayCounter.getCPtr(paymentDayCounter), paymentDayCounter, paymentConvention.swigValue(), DoubleVector.getCPtr(fixedRates), fixedRates, DoubleVector.getCPtr(caps), caps, DoubleVector.getCPtr(floors), floors, Period.getCPtr(exCouponPeriod), exCouponPeriod, Calendar.getCPtr(exCouponCalendar), exCouponCalendar, exCouponConvention.swigValue(), exCouponEndOfMonth, Calendar.getCPtr(paymentCalendar), paymentCalendar, growthOnly, observationInterpolation.swigValue()), true);
  }

  public static Leg CPILeg(DoubleVector nominals, Schedule schedule, ZeroInflationIndex index, double baseCPI, Period observationLag, DayCounter paymentDayCounter, BusinessDayConvention paymentConvention, DoubleVector fixedRates, DoubleVector caps, DoubleVector floors, Period exCouponPeriod, Calendar exCouponCalendar, BusinessDayConvention exCouponConvention, boolean exCouponEndOfMonth, Calendar paymentCalendar, boolean growthOnly) {
  ...
  public static Leg CPILeg(DoubleVector nominals, Schedule schedule, ZeroInflationIndex index, double baseCPI, Period observationLag, DayCounter paymentDayCounter, BusinessDayConvention paymentConvention, DoubleVector fixedRates, DoubleVector caps, DoubleVector floors, Period exCouponPeriod, Calendar exCouponCalendar, BusinessDayConvention exCouponConvention, boolean exCouponEndOfMonth, Calendar paymentCalendar) {
  ...
  public static Leg CPILeg(DoubleVector nominals, Schedule schedule, ZeroInflationIndex index, double baseCPI, Period observationLag, DayCounter paymentDayCounter, BusinessDayConvention paymentConvention, DoubleVector fixedRates, DoubleVector caps, DoubleVector floors, Period exCouponPeriod, Calendar exCouponCalendar, BusinessDayConvention exCouponConvention, boolean exCouponEndOfMonth) {
  ...
  public static Leg CPILeg(DoubleVector nominals, Schedule schedule, ZeroInflationIndex index, double baseCPI, Period observationLag, DayCounter paymentDayCounter, BusinessDayConvention paymentConvention) {
    return new Leg(QuantLibJNI.CPILeg__SWIG_10(DoubleVector.getCPtr(nominals), nominals, Schedule.getCPtr(schedule), schedule, ZeroInflationIndex.getCPtr(index), index, baseCPI, Period.getCPtr(observationLag), observationLag, DayCounter.getCPtr(paymentDayCounter), paymentDayCounter, paymentConvention.swigValue()), true);
  }
  ...
  public static Leg CPILeg(DoubleVector nominals, Schedule schedule, ZeroInflationIndex index, double baseCPI, Period observationLag, DayCounter paymentDayCounter) {
    return new Leg(QuantLibJNI.CPILeg__SWIG_11(DoubleVector.getCPtr(nominals), nominals, Schedule.getCPtr(schedule), schedule, ZeroInflationIndex.getCPtr(index), index, baseCPI, Period.getCPtr(observationLag), observationLag, DayCounter.getCPtr(paymentDayCounter), paymentDayCounter), true);
  }
  ...
  public static Leg CPILeg(DoubleVector nominals, Schedule schedule, ZeroInflationIndex index, double baseCPI, Period observationLag) {
    return new Leg(QuantLibJNI.CPILeg__SWIG_12(DoubleVector.getCPtr(nominals), nominals, Schedule.getCPtr(schedule), schedule, ZeroInflationIndex.getCPtr(index), index, baseCPI, Period.getCPtr(observationLag), observationLag), true);
  }
  ...
  public static void setCouponPricer(Leg arg0, YoYInflationCouponPricer arg1) {
    QuantLibJNI.setCouponPricer__SWIG_2(Leg.getCPtr(arg0), arg0, YoYInflationCouponPricer.getCPtr(arg1), arg1);
  }
  ...
  public static Leg yoyInflationLeg(Schedule schedule, Calendar calendar, YoYInflationIndex index, Period observationLag, CPI.InterpolationType interpolation, DoubleVector notionals, DayCounter paymentDayCounter, BusinessDayConvention paymentAdjustment, long fixingDays, DoubleVector gearings, DoubleVector spreads, DoubleVector caps, DoubleVector floors) {
    return new Leg(QuantLibJNI.yoyInflationLeg__SWIG_0(Schedule.getCPtr(schedule), schedule, Calendar.getCPtr(calendar), calendar, YoYInflationIndex.getCPtr(index), index, Period.getCPtr(observationLag), observationLag, interpolation.swigValue(), DoubleVector.getCPtr(notionals), notionals, DayCounter.getCPtr(paymentDayCounter), paymentDayCounter, paymentAdjustment.swigValue(), fixingDays, DoubleVector.getCPtr(gearings), gearings, DoubleVector.getCPtr(spreads), spreads, DoubleVector.getCPtr(caps), caps, DoubleVector.getCPtr(floors), floors), true);
  }

  public static Leg yoyInflationLeg(Schedule schedule, Calendar calendar, YoYInflationIndex index, Period observationLag, CPI.InterpolationType interpolation, DoubleVector notionals, DayCounter paymentDayCounter, BusinessDayConvention paymentAdjustment, long fixingDays, DoubleVector gearings, DoubleVector spreads, DoubleVector caps) {
    return new Leg(QuantLibJNI.yoyInflationLeg__SWIG_1(Schedule.getCPtr(schedule), schedule, Calendar.getCPtr(calendar), calendar, YoYInflationIndex.getCPtr(index), index, Period.getCPtr(observationLag), observationLag, interpolation.swigValue(), DoubleVector.getCPtr(notionals), notionals, DayCounter.getCPtr(paymentDayCounter), paymentDayCounter, paymentAdjustment.swigValue(), fixingDays, DoubleVector.getCPtr(gearings), gearings, DoubleVector.getCPtr(spreads), spreads, DoubleVector.getCPtr(caps), caps), true);
  }

  public static Leg yoyInflationLeg(Schedule schedule, Calendar calendar, YoYInflationIndex index, Period observationLag, CPI.InterpolationType interpolation, DoubleVector notionals, DayCounter paymentDayCounter, BusinessDayConvention paymentAdjustment, long fixingDays, DoubleVector gearings, DoubleVector spreads) {
    return new Leg(QuantLibJNI.yoyInflationLeg__SWIG_2(Schedule.getCPtr(schedule), schedule, Calendar.getCPtr(calendar), calendar, YoYInflationIndex.getCPtr(index), index, Period.getCPtr(observationLag), observationLag, interpolation.swigValue(), DoubleVector.getCPtr(notionals), notionals, DayCounter.getCPtr(paymentDayCounter), paymentDayCounter, paymentAdjustment.swigValue(), fixingDays, DoubleVector.getCPtr(gearings), gearings, DoubleVector.getCPtr(spreads), spreads), true);
  }

  public static Leg yoyInflationLeg(Schedule schedule, Calendar calendar, YoYInflationIndex index, Period observationLag, CPI.InterpolationType interpolation, DoubleVector notionals, DayCounter paymentDayCounter, BusinessDayConvention paymentAdjustment, long fixingDays, DoubleVector gearings) {
    return new Leg(QuantLibJNI.yoyInflationLeg__SWIG_3(Schedule.getCPtr(schedule), schedule, Calendar.getCPtr(calendar), calendar, YoYInflationIndex.getCPtr(index), index, Period.getCPtr(observationLag), observationLag, interpolation.swigValue(), DoubleVector.getCPtr(notionals), notionals, DayCounter.getCPtr(paymentDayCounter), paymentDayCounter, paymentAdjustment.swigValue(), fixingDays, DoubleVector.getCPtr(gearings), gearings), true);
  }

  public static Leg yoyInflationLeg(Schedule schedule, Calendar calendar, YoYInflationIndex index, Period observationLag, CPI.InterpolationType interpolation, DoubleVector notionals, DayCounter paymentDayCounter, BusinessDayConvention paymentAdjustment, long fixingDays) {
    return new Leg(QuantLibJNI.yoyInflationLeg__SWIG_4(Schedule.getCPtr(schedule), schedule, Calendar.getCPtr(calendar), calendar, YoYInflationIndex.getCPtr(index), index, Period.getCPtr(observationLag), observationLag, interpolation.swigValue(), DoubleVector.getCPtr(notionals), notionals, DayCounter.getCPtr(paymentDayCounter), paymentDayCounter, paymentAdjustment.swigValue(), fixingDays), true);
  }
  ...
  public static Leg yoyInflationLeg(Schedule schedule, Calendar calendar, YoYInflationIndex index, Period observationLag, CPI.InterpolationType interpolation, DoubleVector notionals, DayCounter paymentDayCounter, BusinessDayConvention paymentAdjustment) {
    return new Leg(QuantLibJNI.yoyInflationLeg__SWIG_5(Schedule.getCPtr(schedule), schedule, Calendar.getCPtr(calendar), calendar, YoYInflationIndex.getCPtr(index), index, Period.getCPtr(observationLag), observationLag, interpolation.swigValue(), DoubleVector.getCPtr(notionals), notionals, DayCounter.getCPtr(paymentDayCounter), paymentDayCounter, paymentAdjustment.swigValue()), true);
  }
  ...
  public static Leg yoyInflationLeg(Schedule schedule, Calendar calendar, YoYInflationIndex index, Period observationLag, CPI.InterpolationType interpolation, DoubleVector notionals, DayCounter paymentDayCounter) {
    return new Leg(QuantLibJNI.yoyInflationLeg__SWIG_6(Schedule.getCPtr(schedule), schedule, Calendar.getCPtr(calendar), calendar, YoYInflationIndex.getCPtr(index), index, Period.getCPtr(observationLag), observationLag, interpolation.swigValue(), DoubleVector.getCPtr(notionals), notionals, DayCounter.getCPtr(paymentDayCounter), paymentDayCounter), true);
  }

  public static void simplifyNotificationGraph(Bond bond, boolean unregisterCoupons) {
    QuantLibJNI.simplifyNotificationGraph__SWIG_2(Bond.getCPtr(bond), bond, unregisterCoupons);
  }

  public static void simplifyNotificationGraph(Bond bond) {
    QuantLibJNI.simplifyNotificationGraph__SWIG_3(Bond.getCPtr(bond), bond);
  }
  ...
  public static Date cdsMaturity(Date tradeDate, Period tenor, DateGeneration.Rule rule) {
    return new Date(QuantLibJNI.cdsMaturity(Date.getCPtr(tradeDate), tradeDate, Period.getCPtr(tenor), tenor, rule.swigValue()), true);
  }
