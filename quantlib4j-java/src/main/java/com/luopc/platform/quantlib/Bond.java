...
public class Bond extends Instrument {
  ...
  public Date nextCashFlowDate(Date d) {
    return new Date(QuantLibJNI.Bond_nextCashFlowDate__SWIG_0(swigCPtr, this, Date.getCPtr(d), d), true);
  }

  public Date nextCashFlowDate() {
    return new Date(QuantLibJNI.Bond_nextCashFlowDate__SWIG_1(swigCPtr, this), true);
  }

  public Date previousCashFlowDate(Date d) {
    return new Date(QuantLibJNI.Bond_previousCashFlowDate__SWIG_0(swigCPtr, this, Date.getCPtr(d), d), true);
  }

  public Date previousCashFlowDate() {
    return new Date(QuantLibJNI.Bond_previousCashFlowDate__SWIG_1(swigCPtr, this), true);
  }
  ...
  public boolean isTradable(Date d) {
    return QuantLibJNI.Bond_isTradable__SWIG_0(swigCPtr, this, Date.getCPtr(d), d);
  }

  public boolean isTradable() {
    return QuantLibJNI.Bond_isTradable__SWIG_1(swigCPtr, this);
  }
  ...
  public double yield(BondPrice price, DayCounter dc, Compounding compounding, Frequency freq, Date settlement, double accuracy, long maxEvaluations, double guess) {
    return QuantLibJNI.Bond_yield__SWIG_3(swigCPtr, this, BondPrice.getCPtr(price), price, DayCounter.getCPtr(dc), dc, compounding.swigValue(), freq.swigValue(), Date.getCPtr(settlement), settlement, accuracy, maxEvaluations, guess);
  }

  public double yield(BondPrice price, DayCounter dc, Compounding compounding, Frequency freq, Date settlement, double accuracy, long maxEvaluations) {
    return QuantLibJNI.Bond_yield__SWIG_4(swigCPtr, this, BondPrice.getCPtr(price), price, DayCounter.getCPtr(dc), dc, compounding.swigValue(), freq.swigValue(), Date.getCPtr(settlement), settlement, accuracy, maxEvaluations);
  }

  public double yield(BondPrice price, DayCounter dc, Compounding compounding, Frequency freq, Date settlement, double accuracy) {
    return QuantLibJNI.Bond_yield__SWIG_5(swigCPtr, this, BondPrice.getCPtr(price), price, DayCounter.getCPtr(dc), dc, compounding.swigValue(), freq.swigValue(), Date.getCPtr(settlement), settlement, accuracy);
  }

  public double yield(BondPrice price, DayCounter dc, Compounding compounding, Frequency freq, Date settlement) {
    return QuantLibJNI.Bond_yield__SWIG_6(swigCPtr, this, BondPrice.getCPtr(price), price, DayCounter.getCPtr(dc), dc, compounding.swigValue(), freq.swigValue(), Date.getCPtr(settlement), settlement);
  }

  public double yield(BondPrice price, DayCounter dc, Compounding compounding, Frequency freq) {
    return QuantLibJNI.Bond_yield__SWIG_7(swigCPtr, this, BondPrice.getCPtr(price), price, DayCounter.getCPtr(dc), dc, compounding.swigValue(), freq.swigValue());
  }
