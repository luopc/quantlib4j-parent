...
public class ShortRateModelHandle {
  ...
  public ShortRateModelHandle() {
    this(QuantLibJNI.new_ShortRateModelHandle__SWIG_0(), true);
  }

  public ShortRateModelHandle(ShortRateModel p, boolean registerAsObserver) {
    this(QuantLibJNI.new_ShortRateModelHandle__SWIG_1(ShortRateModel.getCPtr(p), p, registerAsObserver), true);
  }

  public ShortRateModelHandle(ShortRateModel p) {
    this(QuantLibJNI.new_ShortRateModelHandle__SWIG_2(ShortRateModel.getCPtr(p), p), true);
  }
