...
public class BlackCalculator {
  ...
  public double strikeGamma() {
    return QuantLibJNI.BlackCalculator_strikeGamma(swigCPtr, this);
  }

  public double vanna(double spot, double maturity) {
    return QuantLibJNI.BlackCalculator_vanna(swigCPtr, this, spot, maturity);
  }

  public double volga(double maturity) {
    return QuantLibJNI.BlackCalculator_volga(swigCPtr, this, maturity);
  }
