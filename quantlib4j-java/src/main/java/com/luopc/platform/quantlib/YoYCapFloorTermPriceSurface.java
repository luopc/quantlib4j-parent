...
public class YoYCapFloorTermPriceSurface extends TermStructure {
  ...
  public Period observationLag() {
    return new Period(QuantLibJNI.YoYCapFloorTermPriceSurface_observationLag(swigCPtr, this), true);
  }

  public Frequency frequency() {
    return Frequency.swigToEnum(QuantLibJNI.YoYCapFloorTermPriceSurface_frequency(swigCPtr, this));
  }
  ...
  public Date baseDate() {
    return new Date(QuantLibJNI.YoYCapFloorTermPriceSurface_baseDate(swigCPtr, this), true);
  }
