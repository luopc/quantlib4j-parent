...
public class UnitedStates extends Calendar {
  ...
  public final static class Market {
    ...
    public final static UnitedStates.Market SOFR = new UnitedStates.Market("SOFR");
    ...
    private static Market[] swigValues = { Settlement, NYSE, GovernmentBond, NERC, LiborImpact, FederalReserve, SOFR };
