...
public class PiecewiseSplineCubicDiscount extends YieldTermStructure {
  ...
  public PiecewiseSplineCubicDiscount(Date referenceDate, RateHelperVector instruments, DayCounter dayCounter, IterativeBootstrap b, SplineCubic i) {
    this(QuantLibJNI.new_PiecewiseSplineCubicDiscount__SWIG_10(Date.getCPtr(referenceDate), referenceDate, RateHelperVector.getCPtr(instruments), instruments, DayCounter.getCPtr(dayCounter), dayCounter, IterativeBootstrap.getCPtr(b), b, SplineCubic.getCPtr(i), i), true);
  }
  ...
  public PiecewiseSplineCubicDiscount(Date referenceDate, RateHelperVector instruments, DayCounter dayCounter, IterativeBootstrap b) {
    this(QuantLibJNI.new_PiecewiseSplineCubicDiscount__SWIG_11(Date.getCPtr(referenceDate), referenceDate, RateHelperVector.getCPtr(instruments), instruments, DayCounter.getCPtr(dayCounter), dayCounter, IterativeBootstrap.getCPtr(b), b), true);
  }

  public PiecewiseSplineCubicDiscount(int settlementDays, Calendar calendar, RateHelperVector instruments, DayCounter dayCounter, IterativeBootstrap b, SplineCubic i) {
    this(QuantLibJNI.new_PiecewiseSplineCubicDiscount__SWIG_12(settlementDays, Calendar.getCPtr(calendar), calendar, RateHelperVector.getCPtr(instruments), instruments, DayCounter.getCPtr(dayCounter), dayCounter, IterativeBootstrap.getCPtr(b), b, SplineCubic.getCPtr(i), i), true);
  }
  ...
  public PiecewiseSplineCubicDiscount(int settlementDays, Calendar calendar, RateHelperVector instruments, DayCounter dayCounter, IterativeBootstrap b) {
    this(QuantLibJNI.new_PiecewiseSplineCubicDiscount__SWIG_13(settlementDays, Calendar.getCPtr(calendar), calendar, RateHelperVector.getCPtr(instruments), instruments, DayCounter.getCPtr(dayCounter), dayCounter, IterativeBootstrap.getCPtr(b), b), true);
  }
  ...
  public DoubleVector data() {
    return new DoubleVector(QuantLibJNI.PiecewiseSplineCubicDiscount_data(swigCPtr, this), false);
  }
