...
public class EndCriteria {
  ...
  public static boolean succeeded(EndCriteria.Type ecType) {
    return QuantLibJNI.EndCriteria_succeeded(ecType.swigValue());
  }
  ...
  public final static class Type {
    ...
    public final static EndCriteria.Type FunctionEpsilonTooSmall = new EndCriteria.Type("FunctionEpsilonTooSmall");
    ...
    private static Type[] swigValues = { None, MaxIterations, StationaryPoint, StationaryFunctionValue, StationaryFunctionAccuracy, ZeroGradientNorm, FunctionEpsilonTooSmall, Unknown };
