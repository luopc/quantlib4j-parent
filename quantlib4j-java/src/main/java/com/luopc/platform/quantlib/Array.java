...
public class Array {
  ...
  public boolean equals(Array other) {
    return QuantLibJNI.Array_equals(swigCPtr, this, Array.getCPtr(other), other);
  }

  public boolean unEquals(Array other) {
    return QuantLibJNI.Array_unEquals(swigCPtr, this, Array.getCPtr(other), other);
  }
