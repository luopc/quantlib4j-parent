...
public class CallableBond extends Bond {
  ...
  public double impliedVolatility(BondPrice targetPrice, YieldTermStructureHandle discountCurve, double accuracy, long maxEvaluations, double minVol, double maxVol) {
    return QuantLibJNI.CallableBond_impliedVolatility(swigCPtr, this, BondPrice.getCPtr(targetPrice), targetPrice, YieldTermStructureHandle.getCPtr(discountCurve), discountCurve, accuracy, maxEvaluations, minVol, maxVol);
  }
