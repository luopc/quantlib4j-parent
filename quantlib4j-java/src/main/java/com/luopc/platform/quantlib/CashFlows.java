...
public class CashFlows {
  ...
  public static double accrualPeriod(Leg leg, boolean includeSettlementDateFlows, Date settlementDate) {
    return QuantLibJNI.CashFlows_accrualPeriod__SWIG_0(Leg.getCPtr(leg), leg, includeSettlementDateFlows, Date.getCPtr(settlementDate), settlementDate);
  }

  public static double accrualPeriod(Leg leg, boolean includeSettlementDateFlows) {
    return QuantLibJNI.CashFlows_accrualPeriod__SWIG_1(Leg.getCPtr(leg), leg, includeSettlementDateFlows);
  }

  public static int accrualDays(Leg leg, boolean includeSettlementDateFlows, Date settlementDate) {
    return QuantLibJNI.CashFlows_accrualDays__SWIG_0(Leg.getCPtr(leg), leg, includeSettlementDateFlows, Date.getCPtr(settlementDate), settlementDate);
  }

  public static int accrualDays(Leg leg, boolean includeSettlementDateFlows) {
    return QuantLibJNI.CashFlows_accrualDays__SWIG_1(Leg.getCPtr(leg), leg, includeSettlementDateFlows);
  }

  public static double accruedPeriod(Leg leg, boolean includeSettlementDateFlows, Date settlementDate) {
    return QuantLibJNI.CashFlows_accruedPeriod__SWIG_0(Leg.getCPtr(leg), leg, includeSettlementDateFlows, Date.getCPtr(settlementDate), settlementDate);
  }

  public static double accruedPeriod(Leg leg, boolean includeSettlementDateFlows) {
    return QuantLibJNI.CashFlows_accruedPeriod__SWIG_1(Leg.getCPtr(leg), leg, includeSettlementDateFlows);
  }

  public static int accruedDays(Leg leg, boolean includeSettlementDateFlows, Date settlementDate) {
    return QuantLibJNI.CashFlows_accruedDays__SWIG_0(Leg.getCPtr(leg), leg, includeSettlementDateFlows, Date.getCPtr(settlementDate), settlementDate);
  }

  public static int accruedDays(Leg leg, boolean includeSettlementDateFlows) {
    return QuantLibJNI.CashFlows_accruedDays__SWIG_1(Leg.getCPtr(leg), leg, includeSettlementDateFlows);
  }

  public static double accruedAmount(Leg leg, boolean includeSettlementDateFlows, Date settlementDate) {
    return QuantLibJNI.CashFlows_accruedAmount__SWIG_0(Leg.getCPtr(leg), leg, includeSettlementDateFlows, Date.getCPtr(settlementDate), settlementDate);
  }

  public static double accruedAmount(Leg leg, boolean includeSettlementDateFlows) {
    return QuantLibJNI.CashFlows_accruedAmount__SWIG_1(Leg.getCPtr(leg), leg, includeSettlementDateFlows);
  }
  ...
  public static double npv(Leg leg, YieldTermStructure discountCurve, boolean includeSettlementDateFlows, Date settlementDate, Date npvDate) {
    return QuantLibJNI.CashFlows_npv__SWIG_0(Leg.getCPtr(leg), leg, YieldTermStructure.getCPtr(discountCurve), discountCurve, includeSettlementDateFlows, Date.getCPtr(settlementDate), settlementDate, Date.getCPtr(npvDate), npvDate);
  }

  public static double npv(Leg leg, YieldTermStructure discountCurve, boolean includeSettlementDateFlows, Date settlementDate) {
    return QuantLibJNI.CashFlows_npv__SWIG_1(Leg.getCPtr(leg), leg, YieldTermStructure.getCPtr(discountCurve), discountCurve, includeSettlementDateFlows, Date.getCPtr(settlementDate), settlementDate);
  }

  public static double npv(Leg leg, YieldTermStructure discountCurve, boolean includeSettlementDateFlows) {
    return QuantLibJNI.CashFlows_npv__SWIG_2(Leg.getCPtr(leg), leg, YieldTermStructure.getCPtr(discountCurve), discountCurve, includeSettlementDateFlows);
  }
  ...
  public static double npv(Leg leg, YieldTermStructure discountCurve, double zSpread, Compounding compounding, Frequency frequency, OptionalBool includeSettlementDateFlows, Date settlementDate, Date npvDate) {
    return QuantLibJNI.CashFlows_npv__SWIG_12(Leg.getCPtr(leg), leg, YieldTermStructure.getCPtr(discountCurve), discountCurve, zSpread, compounding.swigValue(), frequency.swigValue(), OptionalBool.getCPtr(includeSettlementDateFlows), includeSettlementDateFlows, Date.getCPtr(settlementDate), settlementDate, Date.getCPtr(npvDate), npvDate);
  }

  public static double npv(Leg leg, YieldTermStructure discountCurve, double zSpread, Compounding compounding, Frequency frequency, OptionalBool includeSettlementDateFlows, Date settlementDate) {
    return QuantLibJNI.CashFlows_npv__SWIG_13(Leg.getCPtr(leg), leg, YieldTermStructure.getCPtr(discountCurve), discountCurve, zSpread, compounding.swigValue(), frequency.swigValue(), OptionalBool.getCPtr(includeSettlementDateFlows), includeSettlementDateFlows, Date.getCPtr(settlementDate), settlementDate);
  }

  public static double npv(Leg leg, YieldTermStructure discountCurve, double zSpread, Compounding compounding, Frequency frequency, OptionalBool includeSettlementDateFlows) {
    return QuantLibJNI.CashFlows_npv__SWIG_14(Leg.getCPtr(leg), leg, YieldTermStructure.getCPtr(discountCurve), discountCurve, zSpread, compounding.swigValue(), frequency.swigValue(), OptionalBool.getCPtr(includeSettlementDateFlows), includeSettlementDateFlows);
  }

  public static double npv(Leg leg, YieldTermStructure discountCurve, double zSpread, Compounding compounding, Frequency frequency) {
    return QuantLibJNI.CashFlows_npv__SWIG_15(Leg.getCPtr(leg), leg, YieldTermStructure.getCPtr(discountCurve), discountCurve, zSpread, compounding.swigValue(), frequency.swigValue());
  }
  ...
  public static double npv(Leg leg, YieldTermStructure discountCurve, double zSpread, DayCounter dayCounter, Compounding compounding, Frequency frequency, boolean includeSettlementDateFlows, Date settlementDate, Date npvDate) {
    return QuantLibJNI.CashFlows_npv__SWIG_16(Leg.getCPtr(leg), leg, YieldTermStructure.getCPtr(discountCurve), discountCurve, zSpread, DayCounter.getCPtr(dayCounter), dayCounter, compounding.swigValue(), frequency.swigValue(), includeSettlementDateFlows, Date.getCPtr(settlementDate), settlementDate, Date.getCPtr(npvDate), npvDate);
  }
  ...
  public static double npv(Leg leg, YieldTermStructure discountCurve, double zSpread, DayCounter dayCounter, Compounding compounding, Frequency frequency, boolean includeSettlementDateFlows, Date settlementDate) {
    return QuantLibJNI.CashFlows_npv__SWIG_17(Leg.getCPtr(leg), leg, YieldTermStructure.getCPtr(discountCurve), discountCurve, zSpread, DayCounter.getCPtr(dayCounter), dayCounter, compounding.swigValue(), frequency.swigValue(), includeSettlementDateFlows, Date.getCPtr(settlementDate), settlementDate);
  }
  ...
  public static double npv(Leg leg, YieldTermStructure discountCurve, double zSpread, DayCounter dayCounter, Compounding compounding, Frequency frequency, boolean includeSettlementDateFlows) {
    return QuantLibJNI.CashFlows_npv__SWIG_18(Leg.getCPtr(leg), leg, YieldTermStructure.getCPtr(discountCurve), discountCurve, zSpread, DayCounter.getCPtr(dayCounter), dayCounter, compounding.swigValue(), frequency.swigValue(), includeSettlementDateFlows);
  }
  ...
  public static double zSpread(Leg leg, double npv, YieldTermStructure arg2, Compounding compounding, Frequency frequency, OptionalBool includeSettlementDateFlows, Date settlementDate, Date npvDate, double accuracy, long maxIterations, double guess) {
    return QuantLibJNI.CashFlows_zSpread__SWIG_0(Leg.getCPtr(leg), leg, npv, YieldTermStructure.getCPtr(arg2), arg2, compounding.swigValue(), frequency.swigValue(), OptionalBool.getCPtr(includeSettlementDateFlows), includeSettlementDateFlows, Date.getCPtr(settlementDate), settlementDate, Date.getCPtr(npvDate), npvDate, accuracy, maxIterations, guess);
  }

  public static double zSpread(Leg leg, double npv, YieldTermStructure arg2, Compounding compounding, Frequency frequency, OptionalBool includeSettlementDateFlows, Date settlementDate, Date npvDate, double accuracy, long maxIterations) {
    return QuantLibJNI.CashFlows_zSpread__SWIG_1(Leg.getCPtr(leg), leg, npv, YieldTermStructure.getCPtr(arg2), arg2, compounding.swigValue(), frequency.swigValue(), OptionalBool.getCPtr(includeSettlementDateFlows), includeSettlementDateFlows, Date.getCPtr(settlementDate), settlementDate, Date.getCPtr(npvDate), npvDate, accuracy, maxIterations);
  }

  public static double zSpread(Leg leg, double npv, YieldTermStructure arg2, Compounding compounding, Frequency frequency, OptionalBool includeSettlementDateFlows, Date settlementDate, Date npvDate, double accuracy) {
    return QuantLibJNI.CashFlows_zSpread__SWIG_2(Leg.getCPtr(leg), leg, npv, YieldTermStructure.getCPtr(arg2), arg2, compounding.swigValue(), frequency.swigValue(), OptionalBool.getCPtr(includeSettlementDateFlows), includeSettlementDateFlows, Date.getCPtr(settlementDate), settlementDate, Date.getCPtr(npvDate), npvDate, accuracy);
  }

  public static double zSpread(Leg leg, double npv, YieldTermStructure arg2, Compounding compounding, Frequency frequency, OptionalBool includeSettlementDateFlows, Date settlementDate, Date npvDate) {
    return QuantLibJNI.CashFlows_zSpread__SWIG_3(Leg.getCPtr(leg), leg, npv, YieldTermStructure.getCPtr(arg2), arg2, compounding.swigValue(), frequency.swigValue(), OptionalBool.getCPtr(includeSettlementDateFlows), includeSettlementDateFlows, Date.getCPtr(settlementDate), settlementDate, Date.getCPtr(npvDate), npvDate);
  }

  public static double zSpread(Leg leg, double npv, YieldTermStructure arg2, Compounding compounding, Frequency frequency, OptionalBool includeSettlementDateFlows, Date settlementDate) {
    return QuantLibJNI.CashFlows_zSpread__SWIG_4(Leg.getCPtr(leg), leg, npv, YieldTermStructure.getCPtr(arg2), arg2, compounding.swigValue(), frequency.swigValue(), OptionalBool.getCPtr(includeSettlementDateFlows), includeSettlementDateFlows, Date.getCPtr(settlementDate), settlementDate);
  }

  public static double zSpread(Leg leg, double npv, YieldTermStructure arg2, Compounding compounding, Frequency frequency, OptionalBool includeSettlementDateFlows) {
    return QuantLibJNI.CashFlows_zSpread__SWIG_5(Leg.getCPtr(leg), leg, npv, YieldTermStructure.getCPtr(arg2), arg2, compounding.swigValue(), frequency.swigValue(), OptionalBool.getCPtr(includeSettlementDateFlows), includeSettlementDateFlows);
  }

  public static double zSpread(Leg leg, double npv, YieldTermStructure arg2, Compounding compounding, Frequency frequency) {
    return QuantLibJNI.CashFlows_zSpread__SWIG_6(Leg.getCPtr(leg), leg, npv, YieldTermStructure.getCPtr(arg2), arg2, compounding.swigValue(), frequency.swigValue());
  }
  ...
  public static double zSpread(Leg leg, double npv, YieldTermStructure arg2, DayCounter dayCounter, Compounding compounding, Frequency frequency, boolean includeSettlementDateFlows, Date settlementDate, Date npvDate, double accuracy, long maxIterations, double guess) {
    return QuantLibJNI.CashFlows_zSpread__SWIG_7(Leg.getCPtr(leg), leg, npv, YieldTermStructure.getCPtr(arg2), arg2, DayCounter.getCPtr(dayCounter), dayCounter, compounding.swigValue(), frequency.swigValue(), includeSettlementDateFlows, Date.getCPtr(settlementDate), settlementDate, Date.getCPtr(npvDate), npvDate, accuracy, maxIterations, guess);
  }
  ...
  public static double zSpread(Leg leg, double npv, YieldTermStructure arg2, DayCounter dayCounter, Compounding compounding, Frequency frequency, boolean includeSettlementDateFlows, Date settlementDate, Date npvDate, double accuracy, long maxIterations) {
    return QuantLibJNI.CashFlows_zSpread__SWIG_8(Leg.getCPtr(leg), leg, npv, YieldTermStructure.getCPtr(arg2), arg2, DayCounter.getCPtr(dayCounter), dayCounter, compounding.swigValue(), frequency.swigValue(), includeSettlementDateFlows, Date.getCPtr(settlementDate), settlementDate, Date.getCPtr(npvDate), npvDate, accuracy, maxIterations);
  }
  ...
  public static double zSpread(Leg leg, double npv, YieldTermStructure arg2, DayCounter dayCounter, Compounding compounding, Frequency frequency, boolean includeSettlementDateFlows, Date settlementDate, Date npvDate, double accuracy) {
    return QuantLibJNI.CashFlows_zSpread__SWIG_9(Leg.getCPtr(leg), leg, npv, YieldTermStructure.getCPtr(arg2), arg2, DayCounter.getCPtr(dayCounter), dayCounter, compounding.swigValue(), frequency.swigValue(), includeSettlementDateFlows, Date.getCPtr(settlementDate), settlementDate, Date.getCPtr(npvDate), npvDate, accuracy);
  }
  ...
  public static double zSpread(Leg leg, double npv, YieldTermStructure arg2, DayCounter dayCounter, Compounding compounding, Frequency frequency, boolean includeSettlementDateFlows, Date settlementDate, Date npvDate) {
    return QuantLibJNI.CashFlows_zSpread__SWIG_10(Leg.getCPtr(leg), leg, npv, YieldTermStructure.getCPtr(arg2), arg2, DayCounter.getCPtr(dayCounter), dayCounter, compounding.swigValue(), frequency.swigValue(), includeSettlementDateFlows, Date.getCPtr(settlementDate), settlementDate, Date.getCPtr(npvDate), npvDate);
  }
  ...
  public static double zSpread(Leg leg, double npv, YieldTermStructure arg2, DayCounter dayCounter, Compounding compounding, Frequency frequency, boolean includeSettlementDateFlows, Date settlementDate) {
    return QuantLibJNI.CashFlows_zSpread__SWIG_11(Leg.getCPtr(leg), leg, npv, YieldTermStructure.getCPtr(arg2), arg2, DayCounter.getCPtr(dayCounter), dayCounter, compounding.swigValue(), frequency.swigValue(), includeSettlementDateFlows, Date.getCPtr(settlementDate), settlementDate);
  }
  ...
  public static double zSpread(Leg leg, double npv, YieldTermStructure arg2, DayCounter dayCounter, Compounding compounding, Frequency frequency, boolean includeSettlementDateFlows) {
    return QuantLibJNI.CashFlows_zSpread__SWIG_12(Leg.getCPtr(leg), leg, npv, YieldTermStructure.getCPtr(arg2), arg2, DayCounter.getCPtr(dayCounter), dayCounter, compounding.swigValue(), frequency.swigValue(), includeSettlementDateFlows);
  }
