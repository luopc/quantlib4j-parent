...
public class SabrSmileSection extends SmileSection {
  ...
  public SabrSmileSection(double timeToExpiry, double forward, DoubleVector sabrParameters, double shift, VolatilityType volatilityType) {
    this(QuantLibJNI.new_SabrSmileSection__SWIG_5(timeToExpiry, forward, DoubleVector.getCPtr(sabrParameters), sabrParameters, shift, volatilityType.swigValue()), true);
  }

  public SabrSmileSection(double timeToExpiry, double forward, DoubleVector sabrParameters, double shift) {
    this(QuantLibJNI.new_SabrSmileSection__SWIG_6(timeToExpiry, forward, DoubleVector.getCPtr(sabrParameters), sabrParameters, shift), true);
  }

  public SabrSmileSection(double timeToExpiry, double forward, DoubleVector sabrParameters) {
    this(QuantLibJNI.new_SabrSmileSection__SWIG_7(timeToExpiry, forward, DoubleVector.getCPtr(sabrParameters), sabrParameters), true);
  }
