...
public class AnalyticHestonEngine_Integration {
  ...
  public static AnalyticHestonEngine_Integration gaussLobatto(double relTolerance, double absTolerance, long maxEvaluations, boolean useConvergenceEstimate) {
    return new AnalyticHestonEngine_Integration(QuantLibJNI.AnalyticHestonEngine_Integration_gaussLobatto__SWIG_0(relTolerance, absTolerance, maxEvaluations, useConvergenceEstimate), true);
  }

  public static AnalyticHestonEngine_Integration gaussLobatto(double relTolerance, double absTolerance, long maxEvaluations) {
    return new AnalyticHestonEngine_Integration(QuantLibJNI.AnalyticHestonEngine_Integration_gaussLobatto__SWIG_1(relTolerance, absTolerance, maxEvaluations), true);
  }

  public static AnalyticHestonEngine_Integration gaussLobatto(double relTolerance, double absTolerance) {
    return new AnalyticHestonEngine_Integration(QuantLibJNI.AnalyticHestonEngine_Integration_gaussLobatto__SWIG_2(relTolerance, absTolerance), true);
  }
  ...
  public static AnalyticHestonEngine_Integration expSinh(double relTolerance) {
    return new AnalyticHestonEngine_Integration(QuantLibJNI.AnalyticHestonEngine_Integration_expSinh__SWIG_0(relTolerance), true);
  }

  public static AnalyticHestonEngine_Integration expSinh() {
    return new AnalyticHestonEngine_Integration(QuantLibJNI.AnalyticHestonEngine_Integration_expSinh__SWIG_1(), true);
  }
