...
public class CPI {
  ...
  public static double laggedYoYRate(YoYInflationIndex index, Date date, Period observationLag, CPI.InterpolationType interpolationType) {
    return QuantLibJNI.CPI_laggedYoYRate(YoYInflationIndex.getCPtr(index), index, Date.getCPtr(date), date, Period.getCPtr(observationLag), observationLag, interpolationType.swigValue());
  }
