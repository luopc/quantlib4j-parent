...
public class QuoteHandle {
  ...
  public QuoteHandle() {
    this(QuantLibJNI.new_QuoteHandle__SWIG_0(), true);
  }

  public QuoteHandle(Quote p, boolean registerAsObserver) {
    this(QuantLibJNI.new_QuoteHandle__SWIG_1(Quote.getCPtr(p), p, registerAsObserver), true);
  }

  public QuoteHandle(Quote p) {
    this(QuantLibJNI.new_QuoteHandle__SWIG_2(Quote.getCPtr(p), p), true);
  }
