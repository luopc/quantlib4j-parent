...
public class FdBatesVanillaEngine extends PricingEngine {
  ...
  public FdBatesVanillaEngine(BatesModel model, DividendSchedule dividends, long tGrid, long xGrid, long vGrid, long dampingSteps, FdmSchemeDesc schemeDesc) {
    this(QuantLibJNI.new_FdBatesVanillaEngine__SWIG_6(BatesModel.getCPtr(model), model, DividendSchedule.getCPtr(dividends), dividends, tGrid, xGrid, vGrid, dampingSteps, FdmSchemeDesc.getCPtr(schemeDesc), schemeDesc), true);
  }
  ...
  public FdBatesVanillaEngine(BatesModel model, DividendSchedule dividends, long tGrid, long xGrid, long vGrid, long dampingSteps) {
    this(QuantLibJNI.new_FdBatesVanillaEngine__SWIG_7(BatesModel.getCPtr(model), model, DividendSchedule.getCPtr(dividends), dividends, tGrid, xGrid, vGrid, dampingSteps), true);
  }

  public FdBatesVanillaEngine(BatesModel model, DividendSchedule dividends, long tGrid, long xGrid, long vGrid) {
    this(QuantLibJNI.new_FdBatesVanillaEngine__SWIG_8(BatesModel.getCPtr(model), model, DividendSchedule.getCPtr(dividends), dividends, tGrid, xGrid, vGrid), true);
  }

  public FdBatesVanillaEngine(BatesModel model, DividendSchedule dividends, long tGrid, long xGrid) {
    this(QuantLibJNI.new_FdBatesVanillaEngine__SWIG_9(BatesModel.getCPtr(model), model, DividendSchedule.getCPtr(dividends), dividends, tGrid, xGrid), true);
  }

  public FdBatesVanillaEngine(BatesModel model, DividendSchedule dividends, long tGrid) {
    this(QuantLibJNI.new_FdBatesVanillaEngine__SWIG_10(BatesModel.getCPtr(model), model, DividendSchedule.getCPtr(dividends), dividends, tGrid), true);
  }

  public FdBatesVanillaEngine(BatesModel model, DividendSchedule dividends) {
    this(QuantLibJNI.new_FdBatesVanillaEngine__SWIG_11(BatesModel.getCPtr(model), model, DividendSchedule.getCPtr(dividends), dividends), true);
  }
