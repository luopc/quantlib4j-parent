...
public class ZeroInflationIndex extends InflationIndex {
  ...
  public Date lastFixingDate() {
    return new Date(QuantLibJNI.ZeroInflationIndex_lastFixingDate(swigCPtr, this), true);
  }
  ...
  public boolean needsForecast(Date fixingDate) {
    return QuantLibJNI.ZeroInflationIndex_needsForecast(swigCPtr, this, Date.getCPtr(fixingDate), fixingDate);
  }
