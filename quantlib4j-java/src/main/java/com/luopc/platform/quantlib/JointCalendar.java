...
public class JointCalendar extends Calendar {
  ...
  public JointCalendar(CalendarVector arg0, JointCalendarRule arg1) {
    this(QuantLibJNI.new_JointCalendar__SWIG_6(CalendarVector.getCPtr(arg0), arg0, arg1.swigValue()), true);
  }

  public JointCalendar(CalendarVector arg0) {
    this(QuantLibJNI.new_JointCalendar__SWIG_7(CalendarVector.getCPtr(arg0), arg0), true);
  }
