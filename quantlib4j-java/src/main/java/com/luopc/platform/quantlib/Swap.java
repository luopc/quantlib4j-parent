...
public class Swap extends Instrument {
  ...
  public long numberOfLegs() {
    return QuantLibJNI.Swap_numberOfLegs(swigCPtr, this);
  }
  ...
  public double startDiscounts(long j) {
    return QuantLibJNI.Swap_startDiscounts(swigCPtr, this, j);
  }

  public double endDiscounts(long j) {
    return QuantLibJNI.Swap_endDiscounts(swigCPtr, this, j);
  }

  public double npvDateDiscount() {
    return QuantLibJNI.Swap_npvDateDiscount(swigCPtr, this);
  }

  public boolean payer(long j) {
    return QuantLibJNI.Swap_payer(swigCPtr, this, j);
  }
