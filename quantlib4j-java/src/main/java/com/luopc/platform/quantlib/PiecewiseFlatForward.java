...
public class PiecewiseFlatForward extends YieldTermStructure {
  ...
  public PiecewiseFlatForward(Date referenceDate, RateHelperVector instruments, DayCounter dayCounter, IterativeBootstrap b, BackwardFlat i) {
    this(QuantLibJNI.new_PiecewiseFlatForward__SWIG_10(Date.getCPtr(referenceDate), referenceDate, RateHelperVector.getCPtr(instruments), instruments, DayCounter.getCPtr(dayCounter), dayCounter, IterativeBootstrap.getCPtr(b), b, BackwardFlat.getCPtr(i), i), true);
  }

  public PiecewiseFlatForward(Date referenceDate, RateHelperVector instruments, DayCounter dayCounter, IterativeBootstrap b) {
    this(QuantLibJNI.new_PiecewiseFlatForward__SWIG_11(Date.getCPtr(referenceDate), referenceDate, RateHelperVector.getCPtr(instruments), instruments, DayCounter.getCPtr(dayCounter), dayCounter, IterativeBootstrap.getCPtr(b), b), true);
  }

  public PiecewiseFlatForward(int settlementDays, Calendar calendar, RateHelperVector instruments, DayCounter dayCounter, IterativeBootstrap b, BackwardFlat i) {
    this(QuantLibJNI.new_PiecewiseFlatForward__SWIG_12(settlementDays, Calendar.getCPtr(calendar), calendar, RateHelperVector.getCPtr(instruments), instruments, DayCounter.getCPtr(dayCounter), dayCounter, IterativeBootstrap.getCPtr(b), b, BackwardFlat.getCPtr(i), i), true);
  }
  ...
  public PiecewiseFlatForward(int settlementDays, Calendar calendar, RateHelperVector instruments, DayCounter dayCounter, IterativeBootstrap b) {
    this(QuantLibJNI.new_PiecewiseFlatForward__SWIG_13(settlementDays, Calendar.getCPtr(calendar), calendar, RateHelperVector.getCPtr(instruments), instruments, DayCounter.getCPtr(dayCounter), dayCounter, IterativeBootstrap.getCPtr(b), b), true);
  }
  ...
  public DoubleVector data() {
    return new DoubleVector(QuantLibJNI.PiecewiseFlatForward_data(swigCPtr, this), false);
  }
