...
public class NGNCurrency extends Currency {
  private transient long swigCPtr;

  protected NGNCurrency(long cPtr, boolean cMemoryOwn) {
    super(QuantLibJNI.NGNCurrency_SWIGUpcast(cPtr), cMemoryOwn);
    swigCPtr = cPtr;
  }
  ...
  public synchronized void delete() {
    if (swigCPtr != 0) {
      if (swigCMemOwn) {
        swigCMemOwn = false;
        QuantLibJNI.delete_NGNCurrency(swigCPtr);
      }
      swigCPtr = 0;
    }
    super.delete();
  ...
  public NGNCurrency() {
    this(QuantLibJNI.new_NGNCurrency(), true);
  }
