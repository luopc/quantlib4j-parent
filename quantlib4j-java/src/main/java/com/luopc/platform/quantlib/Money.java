...
public class Money implements Comparable<Money> {
  ...
  @Override public int compareTo(Money other) {
    return QuantLibJNI.Money_compareTo(swigCPtr, this, Money.getCPtr(other), other);
  }

  public boolean equals(Money other) {
    return QuantLibJNI.Money_equals(swigCPtr, this, Money.getCPtr(other), other);
  }

  public boolean unEquals(Money other) {
    return QuantLibJNI.Money_unEquals(swigCPtr, this, Money.getCPtr(other), other);
  }
