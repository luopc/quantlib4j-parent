...
public class MakeVanillaSwap {
  ...
  public MakeVanillaSwap withPaymentConvention(BusinessDayConvention bdc) {
    return new MakeVanillaSwap(QuantLibJNI.MakeVanillaSwap_withPaymentConvention(swigCPtr, this, bdc.swigValue()), false);
  }
  ...
  public MakeVanillaSwap withMaturityEndOfMonth(boolean flag) {
    return new MakeVanillaSwap(QuantLibJNI.MakeVanillaSwap_withMaturityEndOfMonth__SWIG_0(swigCPtr, this, flag), false);
  }

  public MakeVanillaSwap withMaturityEndOfMonth() {
    return new MakeVanillaSwap(QuantLibJNI.MakeVanillaSwap_withMaturityEndOfMonth__SWIG_1(swigCPtr, this), false);
  }
  ...
  public MakeVanillaSwap(Period swapTenor, IborIndex index, double fixedRate, Period forwardStart) {
    this(QuantLibJNI.new_MakeVanillaSwap__SWIG_0(Period.getCPtr(swapTenor), swapTenor, IborIndex.getCPtr(index), index, fixedRate, Period.getCPtr(forwardStart), forwardStart), true);
  }

  public MakeVanillaSwap(Period swapTenor, IborIndex index, double fixedRate) {
    this(QuantLibJNI.new_MakeVanillaSwap__SWIG_1(Period.getCPtr(swapTenor), swapTenor, IborIndex.getCPtr(index), index, fixedRate), true);
  }

  public MakeVanillaSwap(Period swapTenor, IborIndex index) {
    this(QuantLibJNI.new_MakeVanillaSwap__SWIG_2(Period.getCPtr(swapTenor), swapTenor, IborIndex.getCPtr(index), index), true);
  }
