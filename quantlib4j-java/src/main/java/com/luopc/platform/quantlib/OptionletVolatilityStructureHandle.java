...
public class OptionletVolatilityStructureHandle {
  ...
  public OptionletVolatilityStructureHandle() {
    this(QuantLibJNI.new_OptionletVolatilityStructureHandle__SWIG_0(), true);
  }

  public OptionletVolatilityStructureHandle(OptionletVolatilityStructure p, boolean registerAsObserver) {
    this(QuantLibJNI.new_OptionletVolatilityStructureHandle__SWIG_1(OptionletVolatilityStructure.getCPtr(p), p, registerAsObserver), true);
  }

  public OptionletVolatilityStructureHandle(OptionletVolatilityStructure p) {
    this(QuantLibJNI.new_OptionletVolatilityStructureHandle__SWIG_2(OptionletVolatilityStructure.getCPtr(p), p), true);
  }
  ...
  public void enableExtrapolation(boolean b) {
    QuantLibJNI.OptionletVolatilityStructureHandle_enableExtrapolation__SWIG_0(swigCPtr, this, b);
  }

  public void enableExtrapolation() {
    QuantLibJNI.OptionletVolatilityStructureHandle_enableExtrapolation__SWIG_1(swigCPtr, this);
  }

  public void disableExtrapolation(boolean b) {
    QuantLibJNI.OptionletVolatilityStructureHandle_disableExtrapolation__SWIG_0(swigCPtr, this, b);
  }

  public void disableExtrapolation() {
    QuantLibJNI.OptionletVolatilityStructureHandle_disableExtrapolation__SWIG_1(swigCPtr, this);
  }
